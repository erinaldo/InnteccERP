...
{
	[Schema("compras")]
	[Alias("vwrequerimientoimpresion")]
	public class VwRequerimientoimpresion
	{
		[PrimaryKey]
		...
		public  int?  Idimpuestodoc{ get; set; }
		public  string Abreviaturaigvdoc{ get; set; }
		public  string Nombreimpuestdoc{ get; set; }
		public  decimal?  Porcentajeimpuestodoc{ get; set; }
