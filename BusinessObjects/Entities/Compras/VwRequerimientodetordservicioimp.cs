...
{
	[Schema("compras")]
	[Alias("vwrequerimientodetordservicioimp")]
    public class VwRequerimientodetordservicioimp : IEquatable<VwRequerimientodetordcompraimp>
	{
		[PrimaryKey]
        ...
        public bool Equals(VwRequerimientodetordcompraimp other)
        {
            if (other == null) return false;
            return Idrequerimientodet.Equals(other.Idrequerimientodet);
        }
	}
}
