...
{
	[Schema("compras")]
	[Alias("vwordenservicioimpresion")]
	public class VwOrdenservicioimpresion
	{
		[PrimaryKey]
		...
		public string Movilempleado { get; set; }
		...
		public string Ubigeosucursalentrega { get; set; }
		...
		public string Serienumeroreqref { get; set; }
