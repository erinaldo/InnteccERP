...
{
    [Schema("ventas")]
    [Alias("vwnotacreditoclireciboingresoimp")]
    public class VwNotacreditoclireciboingresoimp
    {
        [PrimaryKey]
        ...
        public string Codigotipocpventa { get; set; }
        public int? Idtipoformatocpventa { get; set; }
        public string Nombretipoformatocpventa { get; set; }
        public string Abreviaturatipoformatocpventa { get; set; }
        public string Seriecpventa { get; set; }
        public string Numerocpventa { get; set; }
        public DateTime? Fechaemisioncventa { get; set; }
        public decimal Totalncimportado { get; set; }
