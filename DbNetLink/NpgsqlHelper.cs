...
namespace DbNetLink.Data
{
    ...
    public static class NpgsqlHelper
    {
        ...
        private static void AttachParameters(NpgsqlCommand command, IEnumerable<NpgsqlParameter> commandParameters)
        {
        ...
        private static void AssignParameterValues(IEnumerable<NpgsqlParameter> commandParameters, DataRow dataRow)
        {
        ...
        private static void AssignParameterValues(NpgsqlParameter[] commandParameters, object[] parameterValues)
        {
            ...
            for (int i = 0, j = commandParameters.Length; i < j; i++)
            {
                ...
                if (value != null)
                {
                    IDbDataParameter paramInstance = value;
        ...
        private static void PrepareCommand(NpgsqlCommand command, NpgsqlConnection connection, NpgsqlTransaction transaction, CommandType commandType, string commandText, IEnumerable<NpgsqlParameter> commandParameters, out bool mustCloseConnection)
        {
            if (command == null) throw new ArgumentNullException("command");
        ...
        private static NpgsqlDataReader ExecuteReader(NpgsqlConnection connection, NpgsqlTransaction transaction, CommandType commandType, string commandText, IEnumerable<NpgsqlParameter> commandParameters, NpgsqlConnectionOwnership connectionOwnership)
        {
            if (connection == null) throw new ArgumentNullException("connection");
            ...
            try
            {
                ...
                NpgsqlDataReader dataReader = connectionOwnership == NpgsqlConnectionOwnership.External ? cmd.ExecuteReader() : cmd.ExecuteReader(CommandBehavior.CloseConnection);
        ...
        public static NpgsqlDataReader ExecuteReader(NpgsqlConnection connection, CommandType commandType, string commandText, params NpgsqlParameter[] commandParameters)
        {
            ...
            return ExecuteReader(connection, null, commandType, commandText, commandParameters, NpgsqlConnectionOwnership.External);
        }
        ...
        public static NpgsqlCommand CreateCommand(NpgsqlConnection connection, string spName, params string[] sourceColumns)
        {
            ...
            var cmd = new NpgsqlCommand(spName, connection) { CommandType = CommandType.StoredProcedure };
    ...
    /// </summary>
    public static class NpgsqlHelperParameterCache
    {
        ...
        {
            var clonedParameters = new NpgsqlParameter[originalParameters.Length];
        ...
        public static NpgsqlParameter[] GetCachedParameterSet(string connectionString, string commandText)
        {
            ...
            var cachedParameters = ParamCache[hashKey] as NpgsqlParameter[];
        ...
        {
            if (connection == null) throw new ArgumentNullException("connection");
            using (var clonedConnection = (NpgsqlConnection)((ICloneable)connection).Clone())
            {
