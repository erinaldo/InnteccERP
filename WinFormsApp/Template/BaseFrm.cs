...
namespace WinFormsApp
{
    ...
    {        
        ...
        private static BaseFrm _uniqueInstance;
        ...
        private BaseFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idpersona";            
        }

        public static BaseFrm GetInstance()
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwPersona("razonsocial");
