...
{
    public partial class BuscadorArticuloUnidadFrm : XtraForm
    {
        public VwArticulounidad VwArticulounidad { get; set; }
        ...
        public BuscadorArticuloUnidadFrm()
        {
            InitializeComponent();
        ...
        public BuscadorArticuloUnidadFrm(bool buscarSoloItemServicio)
        {
            InitializeComponent();
        ...
        private void BuscarArticuloPorNombre()
        {
            ...
            gcArticulo.DataSource = Service.GetAllVwArticulounidad(whereDinamico + _criterioArticuloServicio, "nombrearticulo");
            Cursor = Cursors.Default;
        }
