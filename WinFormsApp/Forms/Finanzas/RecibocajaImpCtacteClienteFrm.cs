...
{
    public partial class RecibocajaImpCtacteClienteFrm : XtraForm
    {
        ...
        private List<VwCtactecliente> _vwCtacteclienteList;
        public List<VwRecibocajaingresodet> VwRecibocajadetList { get; set; }
        public VwRecibocajaingreso VwRecibocajaSel { get; set; }
        public VwSocionegocio VwSocionegocioSel { get; set; }
        public int IdTipoMoneda { get; set; }

        public RecibocajaImpCtacteClienteFrm(List<VwRecibocajaingresodet> vwRecibocajadetList, VwSocionegocio vwSocionegocioSel, int idTipoMoneda)
        {
        ...
        private void RecibocajaImpCtacteClienteFrm_Load(object sender, EventArgs e)
        {
            CargarReferencias();
        ...
        private void CargarCuentaCorriente()
        {
            ...
            switch (cboBuscarPor.SelectedIndex)
            {
                ...
                case 1: //Cotizaciones
                    ...
                    whereCot = string.Format(@"idtipocp = {0} and serietipocp = '{1}'
                        and numerotipocp = '{2}' and idsucursal = {3} and {4} and idsocionegocio = {5} and idtipomoenda = {6}",
            ...
            _vwCtacteclienteList = Service.GetAllVwCtactecliente(whereCot, "abreviaturatipoformato,serietipocp,numerotipocp");


            gcDocImp.BeginUpdate();
            gcDocImp.DataSource = _vwCtacteclienteList;
            gcDocImp.EndUpdate();
        ...
        private void RecibocajaImpCtacteClienteFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        {
            VwCtactecliente itemSel = (VwCtactecliente)gvDocImp.GetFocusedRow();
        ...
        {
            foreach (var item in _vwCtacteclienteList)
            {
