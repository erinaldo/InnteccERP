...
{
    public partial class RecibocajaegresoMntItemFrm : XtraForm
    {
        ...
        public RecibocajaegresoMntItemFrm(TipoMantenimiento tipoMnt, VwRecibocajaegresodet vwRecibocajadet)
        {
        ...
        private void RecibocajaegresoMntItemFrm_Load(object sender, EventArgs e)
        {
            switch (TipoMnt)
            {
        ...
        private void TraerDatos()
        {
            ...
            iImportepago.EditValue = VwRecibocajadetMnt.Importepago;
            iIdcpcompra.EditValue = VwRecibocajadetMnt.Idcpcompra;
        }
        ...
        private void bmMntItems_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            switch (e.Item.Name)
            {
                case "btnGrabarItem":
                    ...
                    VwRecibocajadetMnt.Idcpcompra = (int?)iIdcpcompra.EditValue;
        ...
        private void RecibocajaegresoMntItemFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
