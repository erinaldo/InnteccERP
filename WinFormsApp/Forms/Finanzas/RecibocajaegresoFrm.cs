...
{
    public partial class RecibocajaegresoFrm : XtraForm
    {        
        ...
        private static RecibocajaegresoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private RecibocajaegresoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idrecibocajaegreso";            
        }

        public static RecibocajaegresoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new RecibocajaegresoFrm();
                }
        ...
        private void RecibocajaegresoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwRecibocajaegreso(where, "nombretipoformato,serierecibo,numerorecibo,fecharecibo");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new RecibocajaegresoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteRecibocajaegreso(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void RecibocajaegresoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
