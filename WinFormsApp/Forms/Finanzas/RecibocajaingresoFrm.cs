...
{
    public partial class RecibocajaingresoFrm : XtraForm
    {        
        ...
        private static RecibocajaingresoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private RecibocajaingresoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idrecibocajaingreso";            
        }

        public static RecibocajaingresoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new RecibocajaingresoFrm();
                }
        ...
        private void RecibocajaingresoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwRecibocajaingreso(where, "nombretipoformato,serierecibo,numerorecibo,fecharecibo");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new RecibocajaingresoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteRecibocajaingreso(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void RecibocajaingresoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
