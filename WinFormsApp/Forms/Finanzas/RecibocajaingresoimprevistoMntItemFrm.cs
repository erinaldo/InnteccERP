...
{
    public partial class RecibocajaingresoimprevistoMntItemFrm : XtraForm
    {
        ...
        public VwRecibocajaingresodet VwRecibocajadetRef { get; set; }
        public VwRecibocajaingresoimprevisto VwRecibocajaimprevistosMnt { get; set; }
        ...
        private void RecibocajaingresoimprevistoMntItemFrm_Load(object sender, EventArgs e)
        {
            switch (TipoMnt)
            {
        ...
        private void bmMntItems_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            switch (e.Item.Name)
            {
                case "btnGrabarItem":
                    ...
                    VwRecibocajaimprevistosMnt.Idrecibocajaingresodet = VwRecibocajadetRef.Idrecibocajaingresodet;
        ...
        private void RecibocajaingresoimprevistoMntItemFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
