...
{
    public partial class RendicioncajachicaFrm : XtraForm
    {        
        ...
        private static RendicioncajachicaFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private RendicioncajachicaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idrendicioncajachica";            
        }

        public static RendicioncajachicaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new RendicioncajachicaFrm();
                }
        ...
        private void RendicioncajachicaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            {
                where = string.Format("idsucursal = {0}", SessionApp.SucursalSel.Idsucursal);
            }
            else
            {
                where = string.Format("idsucursal = {0} and idempleado = {1}", SessionApp.SucursalSel.Idsucursal, (SessionApp.EmpleadoSel == null ? 0 : SessionApp.EmpleadoSel.Idempleado));
            }
            var resul = Service.GetAllVwRendicioncajachica(where, "nombretipoformato,serierendicioncaja,numerorendicioncaja");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new RendicioncajachicaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteRendicioncajachica(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void RendicioncajachicaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
