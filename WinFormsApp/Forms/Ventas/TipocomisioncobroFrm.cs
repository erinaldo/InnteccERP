...
{
    public partial class TipocomisioncobroFrm : XtraForm
    {        
        ...
        private static TipocomisioncobroFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipocomisioncobroFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idtipocomisioncobro";
        }

        public static TipocomisioncobroFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipocomisioncobroFrm();
                }
        ...
        private void TipocomisioncobroFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTipocomisioncobro("nombretipocomisioncobro");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TipocomisioncobroMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void TipocomisioncobroFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
