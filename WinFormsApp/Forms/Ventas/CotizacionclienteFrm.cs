...
{
    public partial class CotizacionclienteFrm : XtraForm
    {        
        ...
        private static CotizacionclienteFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();
        public ImpresionFormato ImpresionFormato { get; set; }

        static readonly IService Service = new Service();

        private CotizacionclienteFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idcotizacioncliente";            
        }
        public static CotizacionclienteFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new CotizacionclienteFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void CotizacionclienteFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwCotizacioncliente(where, "nombretipoformato,seriecotizacion,numerocotizacion,numeronegociacion");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new CotizacionclienteMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteCotizacioncliente(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void bmConsulta_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            switch (e.Item.Name)
            {
                ...
                case "btnExportXlsx":
                    ...
                    break;
                case "btnCopiarCotizacion1":
                    TipoMnt = TipoMantenimiento.Modificar;
                    AsignarIdEntidadMnt();
                    if (IdEntidadMnt > 0)
                    {
                        CotizacionClienteCopiarFrm cotizacionClienteCopiarFrm = new CotizacionClienteCopiarFrm(IdEntidadMnt);
                        cotizacionClienteCopiarFrm.ShowDialog();
                        if (cotizacionClienteCopiarFrm.DialogResult == DialogResult.OK)
                        {
                            CargarDatosConsulta();
                        }
                    }
                    break;
                case "btnCopiarCotizacionNuevo":
                    TipoMnt = TipoMantenimiento.Modificar;
                    AsignarIdEntidadMnt();
                    if (IdEntidadMnt > 0)
                    {
                        CotizacionClienteCopiarNuevoFrm cotizacionClienteCopiarNuevoFrm = new CotizacionClienteCopiarNuevoFrm(IdEntidadMnt);
                        cotizacionClienteCopiarNuevoFrm.ShowDialog();
                        if (cotizacionClienteCopiarNuevoFrm.DialogResult == DialogResult.OK)
                        {
                            CargarDatosConsulta();
                        }
                    }
        ...
        private void CotizacionclienteFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
