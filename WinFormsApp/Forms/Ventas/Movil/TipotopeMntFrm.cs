...
{
    public partial class TipotopeMntFrm : XtraForm
    {
        ...
        public TipotopeFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Tipotope TipotopeMnt { get; set; }

        public TipotopeMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, TipotopeFrm formParent) 
        {
        ...
        private void TipotopeMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void TraerDatos()
        {
            try
            {
                TipotopeMnt = Service.GetTipotope(IdEntidadMnt);

                iNombreTipotope.EditValue = TipotopeMnt.Nombretipotope;
        ...
        private bool Guardar()
        {
            ...
            TipotopeMnt.Nombretipotope = iNombreTipotope.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveTipotope(TipotopeMnt);
                    TipotopeMnt.Idtipotope= IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateTipotope(TipotopeMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteTipotope(IdEntidadMnt);
        ...
        private void TipotopeMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void TipotopeMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
