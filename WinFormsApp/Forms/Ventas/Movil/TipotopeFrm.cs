...
{
    public partial class TipotopeFrm : XtraForm
    {        
        ...
        private static TipotopeFrm _uniqueInstance;
        ...
        private TipotopeFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idtipotope";
        }

        public static TipotopeFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipotopeFrm();
                }
        ...
        private void TipotopeFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTipotope("nombretipotope");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TipotopeMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void TipotopeFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
