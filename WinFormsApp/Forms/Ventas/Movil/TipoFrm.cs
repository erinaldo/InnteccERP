...
{
    public partial class TipoFrm : XtraForm
    {        
        ...
        private static TipoFrm _uniqueInstance;
        ...
        private TipoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idtipo";
        }

        public static TipoFrm GetInstance()
        {
        ...
        private void TipoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTipo("nombreTipo");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TipoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void TipoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
