...
{
    public partial class PlanMntFrm : XtraForm
    {
        ...
        public PlanFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Plan PlanMnt { get; set; }

        public PlanMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, PlanFrm formParent) 
        {
        ...
        private void PlanMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void TraerDatos()
        {
            try
            {
                PlanMnt = Service.GetPlan(IdEntidadMnt);

                iNombrePlan.EditValue = PlanMnt.Nombreplan;
        ...
        private bool Guardar()
        {
            ...
            PlanMnt.Nombreplan = iNombrePlan.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SavePlan(PlanMnt);
                    PlanMnt.Idplan= IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdatePlan(PlanMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeletePlan(IdEntidadMnt);
        ...
        private void PlanMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void PlanMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
