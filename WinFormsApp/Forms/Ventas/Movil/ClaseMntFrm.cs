...
{
    public partial class ClaseMntFrm : XtraForm
    {
        ...
        public ClaseFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Clase ClaseMnt { get; set; }

        public ClaseMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, ClaseFrm formParent) 
        {
        ...
        private void ClaseMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void TraerDatos()
        {
            try
            {
                ClaseMnt = Service.GetClase(IdEntidadMnt);

                iNombreClase.EditValue = ClaseMnt.Nombreclase;
        ...
        private bool Guardar()
        {
            ...
            ClaseMnt.Nombreclase = iNombreClase.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveClase(ClaseMnt);
                    ClaseMnt.Idclase= IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateClase(ClaseMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteClase(IdEntidadMnt);
        ...
        private void ClaseMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void ClaseMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
