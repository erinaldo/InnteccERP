...
{
    public partial class ClaseFrm : XtraForm
    {        
        ...
        private static ClaseFrm _uniqueInstance;
        ...
        private ClaseFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idclase";
        }

        public static ClaseFrm GetInstance()
        {
        ...
        private void ClaseFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllClase("nombreclase");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new ClaseMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void ClaseFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
