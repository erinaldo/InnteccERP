...
{
    public partial class PlanFrm : XtraForm
    {        
        ...
        private static PlanFrm _uniqueInstance;
        ...
        private PlanFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idplan";
        }

        public static PlanFrm GetInstance()
        {
        ...
        private void PlanFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllPlan("nombreplan");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new PlanMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void PlanFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
