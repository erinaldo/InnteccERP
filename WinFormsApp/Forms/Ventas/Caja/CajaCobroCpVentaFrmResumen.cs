...
{
    public partial class CajaCobroCpVentaFrmResumen : XtraForm
    {
        ...
        public CajaCobroCpVentaFrmResumen(int idCpVentaSel, int idEmpleadoCajero)
        {
            InitializeComponent();
        ...
        private void CajaCobroCpVentaFrmResumen_Load(object sender, EventArgs e)
        {
            CargarOrdenDeVenta();
        ...
        private void AgregarItemMedioPagoEfectivo()
        {
            ...
            vwRecibocajaingresodet.Recibidomediopago = vwRecibocajaingresodet.Importepago;
        ...
        private void btnCobrar_Click(object sender, EventArgs e)
        {
            ...
            decimal totalPagos = (decimal) nTotalEfectivo.EditValue + (decimal) nTotalOtroMedioPago.EditValue + (decimal)nTotalNotaCredito.EditValue;
            decimal totalDocumento = (decimal)nTotaldocumento.EditValue;
            if (totalPagos != totalDocumento)
            {
        ...
        private void nTotalEfectivo_EditValueChanged(object sender, EventArgs e)
        {
            CalcularVuelto();
        }
        ...
        {
            if ((decimal)nTotalRecibido.EditValue > 0)
            {
                nTotalVuelto.EditValue = (decimal) nTotalRecibido.EditValue - (decimal) nTotalEfectivo.EditValue;
            }
            else
            {
                nTotalVuelto.EditValue = 0.00m;
            }
        }
    }
}