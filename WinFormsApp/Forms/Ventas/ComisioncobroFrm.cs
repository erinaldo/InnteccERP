...
{
    public partial class ComisioncobroFrm : XtraForm
    {        
        ...
        private static ComisioncobroFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private ComisioncobroFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idcomisioncobro";            
        }

        public static ComisioncobroFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ComisioncobroFrm();
                }
        ...
        private void ComisioncobroFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            string whereSucursal = string.Format("idsucursal= {0}", SessionApp.SucursalSel.Idsucursal);

            var resul = Service.GetAllVwComisioncobro(whereSucursal, "nombretipocomisioncobro");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new ComisioncobroMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteModeloautorizacion(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void ComisioncobroFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
