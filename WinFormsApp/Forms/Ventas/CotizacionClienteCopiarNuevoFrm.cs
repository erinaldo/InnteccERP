...
{
    public partial class CotizacionClienteCopiarNuevoFrm : XtraForm
    {
        ...
        public CotizacionClienteCopiarNuevoFrm(int idcotizacioncliente)
        {
            InitializeComponent();
        ...
        private void CotizacionClienteCopiarNuevoFrm_Load(object sender, EventArgs e)
        {
