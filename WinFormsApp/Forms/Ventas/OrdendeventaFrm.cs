...
{
    public partial class OrdendeventaFrm : XtraForm
    {        
        ...
        private static OrdendeventaFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();
        public ImpresionFormato ImpresionFormato { get; set; }

        static readonly IService Service = new Service();

        private OrdendeventaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idordendeventa";            
        }
        public static OrdendeventaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new OrdendeventaFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void OrdendeventaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwOrdendeventa(where, "nombretipoformato,serieordenventa,numeroordenventa");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new OrdendeventaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteOrdendeventa(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void OrdendeventaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
