...
{
    public partial class TipocomisioncobroMntFrm : XtraForm
    {
        ...
        public TipocomisioncobroFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Tipocomisioncobro TipocomisioncobroMnt { get; set; }

        public TipocomisioncobroMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, TipocomisioncobroFrm formParent) 
        {
        ...
        private void TipocomisioncobroMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    TipocomisioncobroMnt = new Tipocomisioncobro();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                TipocomisioncobroMnt = Service.GetTipocomisioncobro(IdEntidadMnt);

                iNombretipocomisioncobro.EditValue = TipocomisioncobroMnt.Nombretipocomisioncobro.Trim();
        ...
        private bool Guardar()
        {
            ...
            TipocomisioncobroMnt.Nombretipocomisioncobro = iNombretipocomisioncobro.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveTipocomisioncobro(TipocomisioncobroMnt);
                    TipocomisioncobroMnt.Idtipocomisioncobro = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateTipocomisioncobro(TipocomisioncobroMnt);
                    break;
                }
        ...
        private void TipocomisioncobroMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void TipocomisioncobroMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
