...
{
    public partial class DetraccionclienteFrm : XtraForm
    {        
        ...
        private static DetraccionclienteFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private DetraccionclienteFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Iddetraccioncliente";            
        }
        public static DetraccionclienteFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new DetraccionclienteFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void DetraccionclienteFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwDetraccioncliente(where, "serienumerodetraccion");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new DetraccionclienteMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteDetraccioncliente(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void DetraccionclienteFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
