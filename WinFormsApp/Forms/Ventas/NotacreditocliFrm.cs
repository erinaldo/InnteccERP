...
{
    public partial class NotacreditocliFrm : XtraForm
    {        
        ...
        private static NotacreditocliFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private NotacreditocliFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idnotacreditocli";            
        }
        public static NotacreditocliFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new NotacreditocliFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void NotacreditocliFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwNotacreditocli(where, "nombretipoformato,serienotacredito,numeronotacredito");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new NotacreditocliMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void NotacreditocliFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
