...
{
    public partial class NotadebitocliMntFrm : XtraForm
    {
        ...
        public NotadebitocliFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Notadebitocli NotadebitocliMnt { get; set; }
        ...
        public NotadebitocliMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, NotadebitocliFrm formParent) 
        {
        ...
        private void NotadebitocliMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void ValoresPorDefecto()
        {
            ...
            if (SessionApp.EmpleadoSel != null)
            {
                ...
                const string nombreTipodocMov = "ND-CLIENTE";
                //Valores por defecto
        ...
        {
            string whereTipoCp = string.Format("nombretipodocmov = '{0}' and idsucursal = '{1}'", "ND-CLIENTE", SessionApp.SucursalSel.Idsucursal);
            ...
            string whereTipoOpe = string.Format("nombretipodocmov = '{0}' and idsucursal = '{1}'", "ND-CLIENTE", SessionApp.SucursalSel.Idsucursal);
            ...
            //iIdcliente.Properties.DataSource = VwSocionegocioList;
            //iIdcliente.Properties.DisplayMember = "Razonsocial";
            //iIdcliente.Properties.ValueMember = "Idsocionegocio";
            //iIdcliente.Properties.BestFitMode = BestFitMode.BestFit;
        ...
        private void TraerDatos()
        {
            try
            {
                ...
                NotadebitocliMnt = Service.GetNotadebitocli(IdEntidadMnt);                
                rIdsucursal.EditValue = NotadebitocliMnt.Idsucursal;
                iIdtipocp.EditValue = NotadebitocliMnt.Idtipocp;
                iIdcptooperacion.EditValue = NotadebitocliMnt.Idcptooperacion;
                rSerieDoc.EditValue = NotadebitocliMnt.Serienotadebito;
                rNumeroDoc.EditValue = NotadebitocliMnt.Numeronotadebito;

                iIdcliente.EditValue = NotadebitocliMnt.Idcliente;
                CargarDatosSocioNegocio(NotadebitocliMnt.Idcliente);

                iFechaemision.EditValue = NotadebitocliMnt.Fechaemision;
                iIdperiodo.EditValue = NotadebitocliMnt.Idperiodo;
                iFechavencimiento.EditValue = NotadebitocliMnt.Fechavencimiento;
                iAnulado.EditValue = NotadebitocliMnt.Anulado;
                iFechaanulado.EditValue = NotadebitocliMnt.Fechaanulado;
                iIdvendedor.EditValue = NotadebitocliMnt.Idempleado;
                //iIdtipocondicion.EditValue = NotacreditocliMnt.Idtipocondicion;
                iTipocambio.EditValue = NotadebitocliMnt.Tipocambio;
                iIdtipomoneda.EditValue = NotadebitocliMnt.Idtipomoneda;
                rTotalbruto.EditValue = NotadebitocliMnt.Totalbruto;
                rTotalgravado.EditValue = NotadebitocliMnt.Totalgravado;
                rTotalinafecto.EditValue = NotadebitocliMnt.Totalinafecto;
                rtotalexonerado.EditValue = NotadebitocliMnt.Totalexonerado;
                rTotalimpuesto.EditValue = NotadebitocliMnt.Totalimpuesto;
                rImportetotal.EditValue = NotadebitocliMnt.Importetotal;
                rPorcentajepercepcion.EditValue = NotadebitocliMnt.Porcentajepercepcion;
                rImportetotalpercepcion.EditValue = NotadebitocliMnt.Importetotalpercepcion;
                rTotaldocumento.EditValue = NotadebitocliMnt.Totaldocumento;
                iGlosacpventa.EditValue = NotadebitocliMnt.Glosanotacredito;
                iIdimpuesto.EditValue = NotadebitocliMnt.Idimpuesto;
                iIncluyeimpuestoitems.EditValue = NotadebitocliMnt.Incluyeimpuestoitems;
                iIdtipolista.EditValue = NotadebitocliMnt.Idtipolista;
                iIddireccionfacturacion.EditValue = NotadebitocliMnt.Iddireccionfacturacion;
                iListadocpventaref.EditValue = NotadebitocliMnt.Listadocpventaref;
            }
            catch
            {
                DeshabilitarBtnMnt();
        ...
        private void CargarDetalle()
        {
            ...
            string where = string.Format("idnotadebitocli = '{0}'", IdEntidadMnt);
            gcDetalle.BeginUpdate();
            VwNotadebitoclidetList = Service.GetAllVwNotadebitoclidet(where, "numeroitem");
            gcDetalle.DataSource = VwNotadebitoclidetList;            
            SumarTotales();            
            gcDetalle.EndUpdate();
        ...
        private bool Guardar()
        {
            ...
            NotadebitocliMnt.Idsucursal = (int?)rIdsucursal.EditValue;
            NotadebitocliMnt.Idtipocp = (int?)iIdtipocp.EditValue;
            NotadebitocliMnt.Idcptooperacion = (int?)iIdcptooperacion.EditValue;
            NotadebitocliMnt.Serienotadebito = rSerieDoc.Text.Trim();
            NotadebitocliMnt.Numeronotadebito = rNumeroDoc.Text.Trim();
            NotadebitocliMnt.Idcliente = (int)iIdcliente.EditValue;

            NotadebitocliMnt.Fechaemision = (DateTime)iFechaemision.EditValue;
            NotadebitocliMnt.Idperiodo = (int)iIdperiodo.EditValue;
            NotadebitocliMnt.Fechavencimiento = (DateTime)iFechavencimiento.EditValue;
            NotadebitocliMnt.Anulado = (bool)iAnulado.EditValue;
            NotadebitocliMnt.Fechaanulado = (DateTime?)iFechaanulado.EditValue;
            NotadebitocliMnt.Idempleado = (int)iIdvendedor.EditValue;
            //NotacreditocliMnt.Idtipocondicion = (int?)iIdtipocondicion.EditValue;
            NotadebitocliMnt.Tipocambio = (decimal)iTipocambio.EditValue;
            NotadebitocliMnt.Idtipomoneda = (int)iIdtipomoneda.EditValue;

            NotadebitocliMnt.Totalbruto = (decimal)rTotalbruto.EditValue;
            NotadebitocliMnt.Totalgravado = (decimal)rTotalgravado.EditValue;
            NotadebitocliMnt.Totalinafecto = (decimal)rTotalinafecto.EditValue;
            NotadebitocliMnt.Totalexonerado = (decimal)rtotalexonerado.EditValue;
            NotadebitocliMnt.Totalimpuesto = (decimal)rTotalimpuesto.EditValue;
            NotadebitocliMnt.Importetotal = (decimal)rImportetotal.EditValue;
            NotadebitocliMnt.Porcentajepercepcion = (decimal)rPorcentajepercepcion.EditValue;
            NotadebitocliMnt.Importetotalpercepcion = (decimal)rImportetotalpercepcion.EditValue;
            NotadebitocliMnt.Totaldocumento = (decimal)rTotaldocumento.EditValue;

            NotadebitocliMnt.Glosanotacredito = iGlosacpventa.Text.Trim();
            NotadebitocliMnt.Idimpuesto = (int)iIdimpuesto.EditValue;
            NotadebitocliMnt.Incluyeimpuestoitems = (bool)iIncluyeimpuestoitems.EditValue;
            NotadebitocliMnt.Idtipolista = (int) iIdtipolista.EditValue;
            NotadebitocliMnt.Iddireccionfacturacion = (int)iIddireccionfacturacion.EditValue;
            NotadebitocliMnt.Listadocpventaref = iListadocpventaref.Text.Trim();
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
            ...
            try
            {
                ...
                case TipoMantenimiento.Nuevo:
                        ...
                        if (Service.GuardarNotaDebitoCli(TipoMnt, NotadebitocliMnt, VwNotadebitoclidetList))
                    {
                        IdEntidadMnt = NotadebitocliMnt.Idnotadebitocli;
                        pkIdEntidad.EditValue = IdEntidadMnt;
                    }
                    else
                    {
                    ...
                    break;
                case TipoMantenimiento.Modificar:
                    Service.GuardarNotaDebitoCli(TipoMnt, NotadebitocliMnt, VwNotadebitoclidetList);
                    break;
                }
        ...
        private void ListarCpVentaReferencia()
        {
            ...
            List<string> serieNumeroCpVentaList = VwNotadebitoclidetList
                .Where(
        ...
        private void NotadebitocliMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void NotadebitocliMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
        ...
        {
            VwNotadebitoclidet item = (VwNotadebitoclidet)gvDetalle.GetFocusedRow();

            TipoMantenimiento tipoMnt = item.Idnotadebitoclidet <= 0 ? TipoMantenimiento.Nuevo : TipoMantenimiento.Modificar;
            switch (tipoMnt)
            {
                case TipoMantenimiento.Nuevo:
        ...
        private void CalculaItem1(VwNotadebitoclidet item)
        {
        ...
        private void CalculaItem2(VwNotadebitoclidet item)
        {
            //VwOrdendeventadet item = (VwOrdendeventadet)gvDetalle.GetFocusedRow();
