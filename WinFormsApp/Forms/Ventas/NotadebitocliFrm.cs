...
{
    public partial class NotadebitocliFrm : XtraForm
    {        
        ...
        private static NotadebitocliFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private NotadebitocliFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idnotadebitocli";            
        }
        public static NotadebitocliFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new NotadebitocliFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void NotadebitocliFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwNotadebitocli(where, "nombretipoformato,serienotadebito,numeronotadebito");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new NotadebitocliMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void NotadebitocliFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
