...
{
    public partial class OrdenservicioFrm : XtraForm
    {        
        ...
        private static OrdenservicioFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private OrdenservicioFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idordenservicio";            
        }
        public static OrdenservicioFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new OrdenservicioFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void OrdenservicioFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwOrdenservicio(where,"nombretipoformato,serieorden,numeroorden");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new OrdenservicioMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteOrdenservicio(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void OrdenservicioFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
