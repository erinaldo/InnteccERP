...
{
    public partial class CpcompraMntImpOcFrm : XtraForm
    {
        ...
        private List<VwOrdencompradetcpcompraimp> _vwOrdencompradetcpcompraimpList;
        public List<VwCpcompradet> VwCpcompradetList { get; set; }
        public VwOrdencompra VwOrdencompraSel { get; set; }
        public VwSocionegocio VwSocionegocioSel { get; set; }
        public CpcompraMntImpOcFrm(List<VwCpcompradet> vwCpcompradetList, VwSocionegocio vwSocionegocioSel)
        {
        ...
        private void CpcompraMntImpOcFrm_Load(object sender, EventArgs e)
        {
            CargarReferencias();
        ...
        private void CargarOrdenesDeCompra()
        {
            ...
            const string whereNoPendientes = @" idordencompra 
                                               ...
                                               from compras.vwordencompradetcpcompraimp a 
            ...
            _vwOrdencompraList = Service.GetAllVwOrdencompra(whereReq, "abreviaturatipoformato,serieorden,numeroorden");
        ...
        private void bmMntItems_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            switch (e.Item.Name)
            {
                case "btnImportar":
                    ...
                    foreach (var item in _vwOrdencompradetcpcompraimpList.Where(x => x.Itemseleccionado))
                    {
                        ...
                        vwCpcompradet.Idordencompradet = item.Idordencompradet;
                        vwCpcompradet.Serienumeroorden = item.Serienumeroorden;
                    ...
                    VwOrdencompraSel = (VwOrdencompra) gvConsulta.GetFocusedRow();
        ...
        private void CpcompraMntImpOcFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        {
            VwOrdencompradetcpcompraimp itemSel = (VwOrdencompradetcpcompraimp)gvDetalleImp.GetFocusedRow();
        ...
        {
            foreach (var item in _vwOrdencompradetcpcompraimpList)
            {
