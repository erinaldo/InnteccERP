...
{
    public partial class CotizacionprvFrm : XtraForm
    {        
        ...
        private static CotizacionprvFrm _uniqueInstance;

        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();
        private CotizacionprvFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idcotizacionprv";            
        }
        public static CotizacionprvFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new CotizacionprvFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void CotizacionprvFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwCotizacionprv(where, "nombretipoformato,seriecotizacionprv,numerocotizacionprv");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new CotizacionprvMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void CotizacionprvFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
