...
{
    public partial class NotacreditoFrm : XtraForm
    {        
        ...
        private static NotacreditoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private NotacreditoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idnotacredito";            
        }
        public static NotacreditoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new NotacreditoFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void NotacreditoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwNotacredito(where, "nombretipoformato,serienotacredito,numeronotacredito");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new NotacreditoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void NotacreditoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
