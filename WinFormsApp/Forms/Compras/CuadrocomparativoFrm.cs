...
{
    public partial class CuadrocomparativoFrm : XtraForm
    {        
        ...
        private static CuadrocomparativoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private CuadrocomparativoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idcuadrocomparativo";            
        }
        public static CuadrocomparativoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new CuadrocomparativoFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void CuadrocomparativoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwCuadrocomparativo(where, "nombretipoformato,seriecc,numerocc");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new CuadrocomparativoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteCuadrocomparativo(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void CuadrocomparativoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
