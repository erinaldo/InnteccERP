...
{
    public partial class CpcompraFrm : XtraForm
    {
        ...
        private static CpcompraFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        public List<VwCpcompra> VwCpcompraList { get; set; }
        ...
        private CpcompraFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idcpcompra";            
        }
        public static CpcompraFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new CpcompraFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void CpcompraFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta(string descripcionFiltroFecha, string fechaInicialConsulta, string fechaFinalConsulta)
        {
            ...
            string filtro = string.Format("idsucursal = {0} and fechaemision between '{1}' and '{2}'", SessionApp.SucursalSel.Idsucursal, fechaInicialConsulta, fechaFinalConsulta);

            VwCpcompraList = Service.GetAllVwCpcompra(filtro, "nombretipoformato,seriecpcompra,numerocpcompra");
            gcConsulta.DataSource = VwCpcompraList;
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteCpcompra(IdEntidadMnt);
                    VwCpcompraList.Remove(VwCpcompraList.SingleOrDefault(x => x.Idcpcompra == IdEntidadMnt));
                    gcConsulta.RefreshDataSource();
                    //CargarDatosConsulta(DescripcionFiltroFecha, FechaInicialConsulta, FechaFinalConsulta);
                }
                catch
        ...
        private void CpcompraFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
