...
{
    public partial class RequerimientoFrm : XtraForm
    {
        ...
        public List<VwRequerimiento> VwRequerimientoList { get; set; }
        ...
        private static RequerimientoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        private static readonly IService Service = new Service();
        private RequerimientoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idrequerimiento";            
        }
        public static RequerimientoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new RequerimientoFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void RequerimientoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta(FiltroConsulta filtroConsultaDefecto)
        {
            ...
            {
                whereReq = string.Format("idsucursal = {0} and fechareq between '{1}' and '{2}'"
            ...
            {
                whereReq = string.Format("idsucursal = {0} and idempleado = {1} and fechareq between '{2}' and '{3}'"
                    , SessionApp.SucursalSel.Idsucursal
            ...
            VwRequerimientoList = Service.GetAllVwRequerimiento(whereReq, "nombretipoformato,seriereq,numeroreq");

            gcConsulta.DataSource = VwRequerimientoList;
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new RequerimientoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();

            switch (formMnt.DataEntityState)
            {
                case DataEntityState.Added:
                    VwRequerimiento vwRequerimientoAdded = Service.GetVwRequerimiento(x => x.Idrequerimiento == formMnt.IdEntidadMnt);                        
                    VwRequerimientoList.Add(vwRequerimientoAdded);
                    IdEntidadMnt = formMnt.IdEntidadMnt;
                    SetFocusIdEntity();
                    EstadoBotonesMantenimiento();
                    break;
                case DataEntityState.Modified:                        
                    VwRequerimiento vwRequerimientoUnchanged = VwRequerimientoList.FirstOrDefault(x => x.Idrequerimiento == formMnt.IdEntidadMnt);
                    int index = VwRequerimientoList.IndexOf(vwRequerimientoUnchanged);
                    VwRequerimientoList.Remove(vwRequerimientoUnchanged);
                    if (vwRequerimientoUnchanged != null)
                    {
                        VwRequerimientoList.Insert(index,Service.GetVwRequerimiento(x => x.Idrequerimiento == formMnt.IdEntidadMnt));
                    }                        
                    break;
                case DataEntityState.Deleted:
                    VwRequerimientoList.Remove(VwRequerimientoList.SingleOrDefault(x => x.Idrequerimiento == formMnt.IdEntidadMnt));
                    break;
            }
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteRequerimiento(IdEntidadMnt);
        ...
        private void bmConsulta_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            switch (e.Item.Name)
            {
                ...
                case "btnEstado":
                    ...
                    {
                        HistorialDocumentosFrm historialDocumentosFrm = new HistorialDocumentosFrm(vwRequerimiento.Idrequerimiento);
        ...
        private void RequerimientoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
