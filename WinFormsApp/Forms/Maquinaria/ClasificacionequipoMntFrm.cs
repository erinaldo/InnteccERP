...
{
    public partial class ClasificacionequipoMntFrm : XtraForm
    {
        ...
        public ClasificacionequipoFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Clasificacionequipo ClasificacionequipoMnt { get; set; }

        public ClasificacionequipoMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, ClasificacionequipoFrm formParent) 
        {
        ...
        private void ClasificacionequipoMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    ClasificacionequipoMnt = new Clasificacionequipo();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                ClasificacionequipoMnt = Service.GetClasificacionequipo(IdEntidadMnt);

                iNombreclasificacionequipo.EditValue = ClasificacionequipoMnt.Nombreclasificacionequipo.Trim();
        ...
        private bool Guardar()
        {
            ...
            ClasificacionequipoMnt.Nombreclasificacionequipo  = iNombreclasificacionequipo.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveClasificacionequipo(ClasificacionequipoMnt);
                    ClasificacionequipoMnt.Idclasificacionequipo  = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateClasificacionequipo(ClasificacionequipoMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteClasificacionequipo(IdEntidadMnt);
        ...
        private void ClasificacionequipoMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void ClasificacionequipoMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
