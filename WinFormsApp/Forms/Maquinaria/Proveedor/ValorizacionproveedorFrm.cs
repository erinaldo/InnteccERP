...
{
    public partial class ValorizacionproveedorFrm : XtraForm
    {        
        ...
        private static ValorizacionproveedorFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private ValorizacionproveedorFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idvalorizacionproveedor";            
        }
        public static ValorizacionproveedorFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ValorizacionproveedorFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void ValorizacionproveedorFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwValorizacionproveedor(where, "nombretipoformato,serievalorizacion,numerovalorizacion");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new ValorizacionproveedorMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteValorizacionproveedor(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void ValorizacionproveedorFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
