...
{
    public partial class ValorizacionImpOrdenventaFrm : XtraForm
    {
        ...
        private List<VwOrdendeventadetvalorizaimp> _vwOrdendeventadetvalorizaimpList;
        public List<VwCpventadet> VwCpventadetList { get; set; }
        public VwOrdendeventadetvalorizaimp VwOrdendeventadetvalorizaimpSel { get; set; }
        ...
        private void ValorizacionImpOrdenventaFrm_Load(object sender, EventArgs e)
        {
            CargarReferencias();
        ...
        private void CargarCotizaconesDeVenta()
        {
            ...
            const string whereNoPendientes = @" idordendeventa 
                                               ...
                                               from ventas.vwordendeventadetvalorizaimp a 
        ...
        private void bmMntItems_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            switch (e.Item.Name)
            {
                case "btnImportar":
                   ...
                   VwOrdendeventadetvalorizaimpSel = (VwOrdendeventadetvalorizaimp) gvDetalleImp.GetFocusedRow();
        ...
        private void ValorizacionImpOrdenventaFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        {
            VwOrdendeventadetvalorizaimp itemSel = (VwOrdendeventadetvalorizaimp)gvDetalleImp.GetFocusedRow();
        ...
        private void CargarDetalleOrdenDeVenta()
        {
            ...
            if (vwOrdendeventaSel != null)
            {
                ...
                _vwOrdendeventadetvalorizaimpList = Service.GetAllVwOrdendeventadetvalorizaimp(where, "numeroitem");

                gcDetalleImp.BeginUpdate();
                gcDetalleImp.DataSource = _vwOrdendeventadetvalorizaimpList;
        ...
        {
            foreach (var item in _vwOrdendeventadetvalorizaimpList)
            {
