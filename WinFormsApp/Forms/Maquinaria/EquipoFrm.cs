...
{
    public partial class EquipoFrm : XtraForm
    {        
        ...
        private static EquipoFrm _uniqueInstance;
        ...
        private EquipoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idequipo";
        }
        public static EquipoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new EquipoFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void EquipoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwEquipo("nombreequipo");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new EquipoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void EquipoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
