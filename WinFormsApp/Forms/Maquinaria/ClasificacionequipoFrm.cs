...
{
    public partial class ClasificacionequipoFrm : XtraForm
    {        
        ...
        private static ClasificacionequipoFrm _uniqueInstance;

        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();
        private ClasificacionequipoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idclasificacionequipo";
        }
        public static ClasificacionequipoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ClasificacionequipoFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void ClasificacionequipoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllClasificacionequipo("Nombreclasificacionequipo");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new ClasificacionequipoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void ClasificacionequipoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
