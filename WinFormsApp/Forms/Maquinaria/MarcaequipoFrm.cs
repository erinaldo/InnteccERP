...
{
    public partial class MarcaequipoFrm : XtraForm
    {        
        ...
        private static MarcaequipoFrm _uniqueInstance;

        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();
        private MarcaequipoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idmarcaequipo";
        }
        public static MarcaequipoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new MarcaequipoFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void MarcaequipoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllMarcaequipo("nombremarcaequipo");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new MarcaequipoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void MarcaequipoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
