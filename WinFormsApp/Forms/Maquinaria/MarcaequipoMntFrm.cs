...
{
    public partial class MarcaequipoMntFrm : XtraForm
    {
        ...
        public MarcaequipoFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Marcaequipo MarcaequipoMnt { get; set; }

        public MarcaequipoMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, MarcaequipoFrm formParent) 
        {
        ...
        private void MarcaequipoMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    MarcaequipoMnt = new Marcaequipo();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                MarcaequipoMnt = Service.GetMarcaequipo(IdEntidadMnt);

                iNombremarcaequipo.EditValue = MarcaequipoMnt.Nombremarcaequipo.Trim();
        ...
        private bool Guardar()
        {
            ...
            MarcaequipoMnt.Nombremarcaequipo  = iNombremarcaequipo.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveMarcaequipo(MarcaequipoMnt);
                    MarcaequipoMnt.Idmarcaequipo  = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateMarcaequipo(MarcaequipoMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteMarcaequipo(IdEntidadMnt);
        ...
        private void MarcaequipoMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void MarcaequipoMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
