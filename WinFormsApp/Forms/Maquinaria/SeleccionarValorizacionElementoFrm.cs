...
{
    public partial class SeleccionarValorizacionElementoFrm : XtraForm
    {
        ...
        public SeleccionarValorizacionElementoFrm()
        {
        ...
        private void SeleccionarValorizacionElementoFrm_Load(object sender, EventArgs e)
        {
            CargarReferencias();
        ...
        private void CargarValorizaciones()
        {
            ...
            {
                case 0://Todos
                    whereCot = string.Format("anulado = '0' and idsucursal = {0} {1}", (int)iIdsucursal.EditValue, condicionNoPendiente);
                    break;
                case 1: //Cotizaciones
                    ...
                    whereCot = string.Format(@"idtipocp = {0} and serievalorizacion = '{1}'
                        and numerovalorizacion = '{2}' and anulado = '0' and idsucursal = {3} {4}",
                        (int)iIdtipocp.EditValue,
                        rSerie.Text.Trim(),
                        iNumero.Text.Trim(),
                        (int)iIdsucursal.EditValue,
                        condicionNoPendiente);
                    break;
            }
        ...
        private void SeleccionarValorizacionElementoFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
