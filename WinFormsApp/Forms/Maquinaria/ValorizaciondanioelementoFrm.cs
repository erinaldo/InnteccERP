...
{
    public partial class ValorizaciondanioelementoFrm : XtraForm
    {        
        ...
        private static ValorizaciondanioelementoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private ValorizaciondanioelementoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idvalorizaciondanioelemento";            
        }
        public static ValorizaciondanioelementoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ValorizaciondanioelementoFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void ValorizaciondanioelementoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwValorizaciondanioelemento(where, "nombretipoformato,seriede,numerode");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new ValorizaciondanioelementoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteValorizaciondanioelemento(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void ValorizaciondanioelementoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
