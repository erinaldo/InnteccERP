...
{
    public partial class OrdentrabajoFrm : XtraForm
    {        
        ...
        private static OrdentrabajoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private OrdentrabajoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idordentrabajo";            
        }
        public static OrdentrabajoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new OrdentrabajoFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void OrdentrabajoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwOrdentrabajo(where, "nombretipoformato,serieordentrabajo,numeroordentrabajo");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new OrdentrabajoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteOrdentrabajo(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void OrdentrabajoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
