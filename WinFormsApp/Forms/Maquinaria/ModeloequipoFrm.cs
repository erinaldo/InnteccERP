...
{
    public partial class ModeloequipoFrm : XtraForm
    {        
        ...
        private static ModeloequipoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private ModeloequipoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idmodeloequipo";
        }

        public static ModeloequipoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ModeloequipoFrm();
                }
        ...
        private void ModeloequipoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwModeloequipo("nombremarcaequipo,nombremodeloequipo");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new ModeloequipoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void ModeloequipoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
