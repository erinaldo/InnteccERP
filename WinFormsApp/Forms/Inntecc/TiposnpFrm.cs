...
{
    public partial class TiposnpFrm : XtraForm
    {        
        ...
        private static TiposnpFrm _uniqueInstance;
        ...
        private TiposnpFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idtiposnp";
        }

        public static TiposnpFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TiposnpFrm();
                }
        ...
        private void TiposnpFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTiposnp("nombretiposnp");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TiposnpMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void TiposnpFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
