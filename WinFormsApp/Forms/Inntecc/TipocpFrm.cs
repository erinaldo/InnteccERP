...
{
    public partial class TipocpFrm : XtraForm
    {        
        ...
        private static TipocpFrm _uniqueInstance;
        ...
        private TipocpFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idtipocp";
        }

        private void TipocpFrm_Load(object sender, EventArgs e)
        {
            RestoreLayoutFromRegistry();
            EstablecerPermisos();
            CargarDatosConsulta();
        }
        public static TipocpFrm GetInstance()
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwTipocp(where,"nombretipocp");
        ...
        private void ShowFormMnt()
        {
            if (TipoMnt == TipoMantenimiento.SinEspecificar)
            {
                ...
                AsignarIdEntidadMnt();
                var formMnt = new TipocpMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
                formMnt.ShowDialog();
                Cursor = Cursors.Default;
        ...
        private void TipocpFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
