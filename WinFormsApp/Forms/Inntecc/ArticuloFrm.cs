...
{
    public partial class ArticuloFrm : XtraForm
    {        
        ...
        private static ArticuloFrm _uniqueInstance;
        ...
        private ArticuloFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idarticulo";            
        }

        public static ArticuloFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ArticuloFrm();
                }
        ...
        private void ArticuloFrm_Load(object sender, EventArgs e)
        {
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteArticulo(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void ArticuloFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
