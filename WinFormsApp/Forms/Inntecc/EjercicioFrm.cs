...
{
    public partial class EjercicioFrm : XtraForm
    {        
        ...
        private static EjercicioFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private EjercicioFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idejercicio";
        }

        public static EjercicioFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new EjercicioFrm();
                }
        ...
        private void EjercicioFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllEjercicio(condicionEmpresa, "anioejercicio");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new EjercicioMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteEjercicio(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void EjercicioFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
