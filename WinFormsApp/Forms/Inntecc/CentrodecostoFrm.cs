...
{
    public partial class CentrodecostoFrm : XtraForm
    {        
        ...
        private static CentrodecostoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private CentrodecostoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idcentrodecosto";
        }

        public static CentrodecostoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new CentrodecostoFrm();
                }
        ...
        private void CentrodecostoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllCentrodecosto(condicion,"codigocentrodecosto");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new CentrodecostoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void CentrodecostoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
