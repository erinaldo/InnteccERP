...
{
    public partial class TipooperacionFrm : XtraForm
    {        
        ...
        private static TipooperacionFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipooperacionFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idtipooperacion";            
        }

        public static TipooperacionFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipooperacionFrm();
                }
        ...
        private void TipooperacionFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTipooperacion("codigotipooperacion");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new TipooperacionMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void TipooperacionFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
