...
{
    public partial class RubronegocioMntFrm : XtraForm
    {
        ...
        public RubronegocioFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Rubronegocio RubronegocioaMnt { get; set; }

        public RubronegocioMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, RubronegocioFrm formParent) 
        {
        ...
        private void RubronegocioMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    RubronegocioaMnt = new Rubronegocio();
                    break;
                case TipoMantenimiento.Modificar:                    
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    CargarReferencias();
        ...
        private void TraerDatos()
        {
            try
            {
                RubronegocioaMnt = Service.GetRubronegocio(IdEntidadMnt);

                iNombrerubronegocio.EditValue = RubronegocioaMnt.Nombrerubronegocio.Trim();
        ...
        private bool Guardar()
        {
            ...
            RubronegocioaMnt.Nombrerubronegocio  = iNombrerubronegocio.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveRubronegocio(RubronegocioaMnt);
                    RubronegocioaMnt.Idrubronegocio  = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateRubronegocio(RubronegocioaMnt);
                    break;
                }
        ...
        private void RubronegocioMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void RubronegocioMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
