...
{
    public partial class TipomediopagoFrm : XtraForm
    {        
        ...
        private static TipomediopagoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipomediopagoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idmediopago";            
        }

        public static TipomediopagoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipomediopagoFrm();
                }
        ...
        private void TipomediopagoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTipomediopago("codigomediopago");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new TipomediopagoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void TipomediopagoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
