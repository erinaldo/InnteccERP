...
{
    public partial class MarcaFrm : XtraForm
    {        
        ...
        private static MarcaFrm _uniqueInstance;
        ...
        private MarcaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idmarca";
        }

        public static MarcaFrm GetInstance()
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllMarca("nombremarca");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new MarcaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void MarcaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
