...
{
    public partial class TipoformatoMntFrm : XtraForm
    {
        ...
        public TipoformatoFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Tipoformato TipoformatoMnt { get; set; }

        public TipoformatoMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, TipoformatoFrm formParent) 
        {
        ...
        private void TipoformatoMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    TipoformatoMnt = new Tipoformato();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                TipoformatoMnt = Service.GetTipoformato(IdEntidadMnt);

                iNombretipoformato.EditValue = TipoformatoMnt.Nombretipoformato.Trim();
                iAbreviaturatipoformato.EditValue = TipoformatoMnt.Abreviaturatipoformato.Trim();
        ...
        private bool Guardar()
        {
            ...
            TipoformatoMnt.Nombretipoformato = iNombretipoformato.Text.Trim();
            TipoformatoMnt.Abreviaturatipoformato = iAbreviaturatipoformato.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveTipoformato(TipoformatoMnt);
                    TipoformatoMnt.Idtipoformato = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateTipoformato(TipoformatoMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteTipoformato(IdEntidadMnt);
        ...
        private void TipoformatoMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void TipoformatoMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
