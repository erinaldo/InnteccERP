...
{
    public partial class ElementogastoFrm : XtraForm
    {        
        ...
        private static ElementogastoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private ElementogastoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idelementogasto";            
        }

        public static ElementogastoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ElementogastoFrm();
                }
        ...
        private void ElementogastoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllElementogasto("codigoelementogasto");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new ElementogastoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteElementogasto(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void ElementogastoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
