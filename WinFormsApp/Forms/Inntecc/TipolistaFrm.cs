...
{
    public partial class TipolistaFrm : XtraForm
    {        
        ...
        private static TipolistaFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipolistaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idtipolista";            
        }

        public static TipolistaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipolistaFrm();
                }
        ...
        private void TipolistaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTipolista("codigotipolista");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new TipolistaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void TipolistaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
