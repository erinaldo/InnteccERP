...
{
    public partial class GrupoeconomicoFrm : XtraForm
    {        
        ...
        private static GrupoeconomicoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private GrupoeconomicoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idgrupoeconomico";
        }

        public static GrupoeconomicoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new GrupoeconomicoFrm();
                }
        ...
        private void GrupoeconomicoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllGrupoeconomico("nombregrupoeconomico");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new GrupoeconomicoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void GrupoeconomicoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
