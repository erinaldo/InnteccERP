...
{
    public partial class UnidadmedidaFrm : XtraForm
    {        
        ...
        private static UnidadmedidaFrm _uniqueInstance;

        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();
        private UnidadmedidaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idunidadmedida";            
        }
        public static UnidadmedidaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new UnidadmedidaFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void UnidadmedidaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllUnidadmedida("codigounidadmedida");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new UnidadmedidaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void UnidadmedidaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
