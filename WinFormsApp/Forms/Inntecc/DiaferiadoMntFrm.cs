...
{
    public partial class DiaferiadoMntFrm : XtraForm
    {
        ...
        public DiaferiadoFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Diaferiado DiaferiadoMnt { get; set; }

        public DiaferiadoMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, DiaferiadoFrm formParent) 
        {
        ...
        private void DiaferiadoMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void TraerDatos()
        {
            try
            {
                DiaferiadoMnt = Service.GetDiaferiado(IdEntidadMnt);

                iFechaferiado.EditValue = DiaferiadoMnt.Fechaferiado;
                iMotivodiaferiado.EditValue = DiaferiadoMnt.Motivodiaferiado;
        ...
        private bool Guardar()
        {
            ...
            DiaferiadoMnt.Fechaferiado = (DateTime) iFechaferiado.EditValue;
            DiaferiadoMnt.Motivodiaferiado = iMotivodiaferiado.Text.Trim();
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveDiaferiado(DiaferiadoMnt);
                    DiaferiadoMnt.Iddiaferiado = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateDiaferiado(DiaferiadoMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteDiaferiado(IdEntidadMnt);
        ...
        private void DiaferiadoMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void DiaferiadoMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
