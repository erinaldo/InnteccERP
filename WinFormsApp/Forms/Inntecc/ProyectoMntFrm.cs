...
{
    public partial class ProyectoMntFrm : XtraForm
    {
        ...
        public ProyectoFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Proyecto ProyectoMnt { get; set; }
        public List<Tipoformato> TipoformatoList { get; set; }

        public ProyectoMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, ProyectoFrm formParent) 
        {
        ...
        private void ProyectoMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void TraerDatos()
        {
            try
            {
                ProyectoMnt = Service.GetProyecto(IdEntidadMnt);
                rCodigoproyecto.EditValue = ProyectoMnt.Codigoproyecto;
                iNombreproyecto.EditValue = ProyectoMnt.Nombreproyecto;
                iEsactivo.EditValue = ProyectoMnt.Esactivo;
                iIdempresa.EditValue = ProyectoMnt.Idempresa;
        ...
        private bool Guardar()
        {
            ...
            ProyectoMnt.Codigoproyecto = rCodigoproyecto.Text.Trim();
            ProyectoMnt.Nombreproyecto = iNombreproyecto.Text.Trim();
            ProyectoMnt.Esactivo = (bool)iEsactivo.EditValue;
            ProyectoMnt.Idempresa = (int)iIdempresa.EditValue;
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveProyecto(ProyectoMnt);
                    ProyectoMnt.Idproyecto = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateProyecto(ProyectoMnt);
                    break;
                }
        ...
        private bool Validaciones()
        {
            ...
            if (Service.CodigoProyectoExiste(rCodigoproyecto.Text.Trim(), SessionApp.EmpresaSel.Idempresa) && TipoMnt == TipoMantenimiento.Nuevo)
            {
                rCodigoproyecto.EditValue = Service.GetSiguienteCodigoProyecto(SessionApp.EmpresaSel.Idempresa);
            } 
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteProyecto(IdEntidadMnt);
        ...
        private void ProyectoMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void ProyectoMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
