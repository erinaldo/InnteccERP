...
{
    public partial class EmpresaFrm : XtraForm
    {        
        ...
        private static EmpresaFrm _uniqueInstance;
        ...
        private EmpresaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idempresa";            
        }

        public static EmpresaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new EmpresaFrm();
                }
        ...
        private void EmpresaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllEmpresa("razonsocial");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new EmpresaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteEmpresa(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void EmpresaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
