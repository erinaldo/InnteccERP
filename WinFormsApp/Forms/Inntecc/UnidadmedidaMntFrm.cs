...
{
    public partial class UnidadmedidaMntFrm : XtraForm
    {
        ...
        public UnidadmedidaFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Unidadmedida UnidadmedidaMnt { get; set; }   

        public UnidadmedidaMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, UnidadmedidaFrm formParent) 
        {
        ...
        private void UnidadmedidaMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void ValoresPorDefecto()
        {
            ...
            rCodigounidadmedida.EditValue = Service.GetSiguienteCodigoUnidadDeMedida();
        }
        ...
        private bool Guardar()
        {
            ...
            UnidadmedidaMnt.Codigounidadmedida = rCodigounidadmedida.Text.Trim();
            UnidadmedidaMnt.Nombreunidadmedida = iNombreunidadmedida.Text.Trim();
            UnidadmedidaMnt.Abrunidadmedida = iAbrunidadmedida.Text.Trim();
            UnidadmedidaMnt.Factorconversion = (int)eFactorconversion.EditValue;
            UnidadmedidaMnt.Essunat = (bool) iEssunat.EditValue;
            

            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    //UnidadmedidaMnt.Createdby = IdUsuario;
                    //UnidadmedidaMnt.Creationdate = DateTime.Now;
                    break;
                case TipoMantenimiento.Modificar:
                    //UnidadmedidaMnt.Modifiedby = IdUsuario;
                    //UnidadmedidaMnt.Lastmodified = DateTime.Now;
                    break;
            }
            ...
            try
            {
                ...
                {
                    case TipoMantenimiento.Nuevo:
                        IdEntidadMnt = Service.SaveUnidadmedida(UnidadmedidaMnt);
                        UnidadmedidaMnt.Idunidadmedida = IdEntidadMnt;
                        pkIdEntidad.EditValue = IdEntidadMnt;
                        break;
                    case TipoMantenimiento.Modificar:
                        Service.UpdateUnidadmedida(UnidadmedidaMnt);
                        break;
                }
        ...
        private bool Validaciones()
        {
            ...
            if (Service.CodigoUnidadDeMedidaExiste(rCodigounidadmedida.Text.Trim()) && TipoMnt == TipoMantenimiento.Nuevo)
            {
                rCodigounidadmedida.EditValue = Service.GetSiguienteCodigoUnidadDeMedida();
            }

            if ((int)eFactorconversion.EditValue == 0)
            {
                XtraMessageBox.Show("Ingrese un factor de conversión valido","Error",MessageBoxButtons.OK,MessageBoxIcon.Warning);
                eFactorconversion.Select();
            }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteUnidadmedida(IdEntidadMnt);
        ...
        private void UnidadmedidaMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
