...
{
    public partial class GrupoeconomicoMntFrm : XtraForm
    {
        ...
        public GrupoeconomicoFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Grupoeconomico GrupoeconomicoMnt { get; set; }

        public GrupoeconomicoMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, GrupoeconomicoFrm formParent) 
        {
        ...
        private void GrupoeconomicoMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    GrupoeconomicoMnt = new Grupoeconomico();
                    break;
                case TipoMantenimiento.Modificar:                    
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    CargarReferencias();
        ...
        private void TraerDatos()
        {
            try
            {
                GrupoeconomicoMnt = Service.GetGrupoeconomico(IdEntidadMnt);
                iNombrerubronegocio.EditValue = GrupoeconomicoMnt.Nombregrupoeconomico.Trim();                
            }
            catch
            {
                DeshabilitarBtnMnt();
        ...
        private bool Guardar()
        {
            ...
            GrupoeconomicoMnt.Nombregrupoeconomico   = iNombrerubronegocio.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveGrupoeconomico(GrupoeconomicoMnt);
                    GrupoeconomicoMnt.Idgrupoeconomico  = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateGrupoeconomico(GrupoeconomicoMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteGrupoeconomico(IdEntidadMnt);
        ...
        private void GrupoeconomicoMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void GrupoeconomicoMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
