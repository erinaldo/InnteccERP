...
{
    public partial class DiaferiadoFrm : XtraForm
    {        
        ...
        private static DiaferiadoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private DiaferiadoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Iddiaferiado";
        }

        public static DiaferiadoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new DiaferiadoFrm();
                }
        ...
        private void DiaferiadoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllDiaferiado("fechaferiado");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new DiaferiadoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void DiaferiadoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
