...
{
    public partial class ListaprecioFrm : XtraForm
    {        
        ...
        private static ListaprecioFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private ListaprecioFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idlistaprecio";
        }

        public static ListaprecioFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ListaprecioFrm();
                }
        ...
        private void ListaprecioFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            string condicion = string.Format("idsucursal = {0}", SessionApp.SucursalSel.Idsucursal);
            gcConsulta.DataSource = Service.GetAllVwListaprecio(condicion, "Nombretipolista");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new ListaprecioMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void ListaprecioFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
