...
{
    public partial class SeriearticuloFrm : XtraForm
    {        
        ...
        private static SeriearticuloFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private SeriearticuloFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idseriearticulo";
        }

        public static SeriearticuloFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new SeriearticuloFrm();
                }
        ...
        private void SeriearticuloFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllSeriearticulo("numeroserieitem");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new SeriearticuloMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteSeriearticulo(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void SeriearticuloFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
