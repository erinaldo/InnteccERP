...
{
    public partial class CategoriasocionegocioMntFrm : XtraForm
    {
        ...
        public CategoriasocionegocioFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Categoriasocionegocio CategoriasocionegocioMnt { get; set; }

        public CategoriasocionegocioMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, CategoriasocionegocioFrm formParent)
        {
        ...
        private void CategoriasocionegocioMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    CategoriasocionegocioMnt = new Categoriasocionegocio();
                    break;
                case TipoMantenimiento.Modificar:
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    CargarReferencias();
        ...
        private void TraerDatos()
        {
            try
            {
                CategoriasocionegocioMnt = Service.GetCategoriasocionegocio(IdEntidadMnt);

                iNombrecategoriasocionegoio.EditValue = CategoriasocionegocioMnt.Nombrecategoriasocionegoio.Trim();
        ...
        private bool Guardar()
        {
            ...
            CategoriasocionegocioMnt.Nombrecategoriasocionegoio = iNombrecategoriasocionegoio.Text.Trim();
            ...
            try
            {
                ...
                {
                    case TipoMantenimiento.Nuevo:
                        IdEntidadMnt = Service.SaveCategoriasocionegocio(CategoriasocionegocioMnt);
                        CategoriasocionegocioMnt.Idcategoriasocionegocio = IdEntidadMnt;
                        pkIdEntidad.EditValue = IdEntidadMnt;
                        break;
                    case TipoMantenimiento.Modificar:
                        Service.UpdateCategoriasocionegocio(CategoriasocionegocioMnt);
                        break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteRubronegocio(IdEntidadMnt);
        ...
        private void CategoriasocionegocioMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void CategoriasocionegocioMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {
                if (SeEliminoObjeto)
