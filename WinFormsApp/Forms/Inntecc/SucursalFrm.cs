...
{
    public partial class SucursalFrm : XtraForm
    {        
        ...
        private static SucursalFrm _uniqueInstance;

        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private Sucursal _sucursalMnt;
        private SucursalFrm()
        {
        ...
        public static SucursalFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new SucursalFrm();
                }
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllSucursal(where,"codigosucursal");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarObjetoMnt();
            SucursalMntFrm formMnt = new SucursalMntFrm(_sucursalMnt, IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void SucursalFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void AsignarObjetoMnt()
        {
            ...
            switch (TipoMnt)
            {
                ...
                case TipoMantenimiento.Modificar:
                    IdEntidadMnt = Convert.ToInt32(gvConsulta.GetRowCellValue(gvConsulta.FocusedRowHandle, NombreColumnaPk));
                    _sucursalMnt = new Sucursal();
                    _sucursalMnt = (Sucursal)gvConsulta.GetFocusedRow();
                    //_sucursalMnt = Service.GetSucursal(IdEntidadMnt);                                 
                    break;
            }            
        }
