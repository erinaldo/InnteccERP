...
{
    public partial class TipocambioFrm : XtraForm
    {        
        ...
        private static TipocambioFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipocambioFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idtipocambio";
        }

        public static TipocambioFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipocambioFrm();
                }
        ...
        private void TipocambioFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwTipocambio("fechatipocambio");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TipocambioMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteTipocambio(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void TipocambioFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
