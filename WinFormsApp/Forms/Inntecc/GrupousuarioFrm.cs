...
{
    public partial class GrupousuarioFrm : XtraForm
    {        
        ...
        private static GrupousuarioFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private GrupousuarioFrm()
        {
        ...
        public static GrupousuarioFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new GrupousuarioFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void GrupousuarioFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllGrupousuario(condicionEmpresa, "nombregrupo");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new GrupousuarioMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        {
            Grupousuario grupousuario = (Grupousuario) gvConsulta.GetFocusedRow();
            ...
            switch (e.Item.Name)
            {
                case "btnNuevo":
                    ...
                    break;
                case "btnModificar":
                    if (grupousuario.Nombregrupo == "ADMINISTRADORES DEL SISTEMA")
                    {
        ...
        private void GrupousuarioFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
