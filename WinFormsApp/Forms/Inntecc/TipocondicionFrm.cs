...
{
    public partial class TipocondicionFrm : XtraForm
    {        
        ...
        private static TipocondicionFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipocondicionFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idtipocondicion";            
        }

        public static TipocondicionFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipocondicionFrm();
                }
        ...
        private void TipocondicionFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTipocondicion("codigocondicion");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new TipocondicionMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void TipocondicionFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
