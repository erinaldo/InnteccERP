...
{
    public partial class EstadoarticuloFrm : XtraForm
    {        
        ...
        private static EstadoarticuloFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private EstadoarticuloFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idestadoarticulo";
        }

        public static EstadoarticuloFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new EstadoarticuloFrm();
                }
        ...
        private void EstadoarticuloFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllEstadoarticulo("nombreestadoarticulo");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new EstadoarticuloMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void EstadoarticuloFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
