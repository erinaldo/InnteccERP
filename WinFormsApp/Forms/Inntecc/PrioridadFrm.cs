...
{
    public partial class PrioridadFrm : XtraForm
    {        
        ...
        private static PrioridadFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private PrioridadFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idprioridad";            
        }

        public static PrioridadFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new PrioridadFrm();
                }
        ...
        private void PrioridadFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllPrioridad("codigoprioridad");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new PrioridadMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void PrioridadFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
