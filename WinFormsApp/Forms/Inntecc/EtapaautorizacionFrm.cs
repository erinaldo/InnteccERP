...
{
    public partial class EtapaautorizacionFrm : XtraForm
    {        
        ...
        private static EtapaautorizacionFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private EtapaautorizacionFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idetapaautorizacion";            
        }

        public static EtapaautorizacionFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new EtapaautorizacionFrm();
                }
        ...
        private void EtapaautorizacionFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwEtapaautorizacion(condicion,"idetapaautorizacion");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new EtapaautorizacionMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EtapaautorizacionFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
