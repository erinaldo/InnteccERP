...
{
    public partial class RubronegocioFrm : XtraForm
    {        
        ...
        private static RubronegocioFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private RubronegocioFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idrubronegocio";
        }

        public static RubronegocioFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new RubronegocioFrm();
                }
        ...
        private void RubronegocioFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllRubronegocio("idrubronegocio"); ;
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new RubronegocioMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void RubronegocioFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
