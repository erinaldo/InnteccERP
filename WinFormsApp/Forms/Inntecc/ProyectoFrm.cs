...
{
    public partial class ProyectoFrm : XtraForm
    {        
        ...
        private static ProyectoFrm _uniqueInstance;
        ...
        private ProyectoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idproyecto";
        }

        public static ProyectoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ProyectoFrm();
                }
        ...
        private void ProyectoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllProyecto(condicion,"codigoproyecto");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new ProyectoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void ProyectoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
