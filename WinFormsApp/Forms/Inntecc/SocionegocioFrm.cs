...
{
    public partial class SocionegocioFrm : XtraForm
    {        
        ...
        private static SocionegocioFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private SocionegocioFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idsocionegocio";            
        }

        public static SocionegocioFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new SocionegocioFrm();
                }
        ...
        private void SocionegocioFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwSocionegocio(condicionEmpresa, "razonsocial");
        ...
        private void SocionegocioFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
