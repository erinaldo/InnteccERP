...
{
    public partial class TipoafectacionigvFrm : XtraForm
    {        
        ...
        private static TipoafectacionigvFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipoafectacionigvFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idtipoafectacionigv";
        }

        public static TipoafectacionigvFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipoafectacionigvFrm();
                }
        ...
        private void TipoafectacionigvFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTipoafectacionigv("codigotipoafectacionigv");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TipoafectacionigvMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void TipoafectacionigvFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
