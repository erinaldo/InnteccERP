...
{
    public partial class TipolistatipocondicionFrm : XtraForm
    {        
        ...
        private static TipolistatipocondicionFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipolistatipocondicionFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idtipolistatipocondicion";            
        }

        public static TipolistatipocondicionFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipolistatipocondicionFrm();
                }
        ...
        private void TipolistatipocondicionFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwTipolistatipocondicion(condicionEmpresa,"codigotipolista");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new TipolistatipocondicionMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteTipolistatipocondicion(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void TipolistatipocondicionFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
