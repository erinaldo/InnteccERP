...
{
    public partial class EstadosocionegocioFrm : XtraForm
    {        
        ...
        private static EstadosocionegocioFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private EstadosocionegocioFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idestadosocionegocio";
        }

        public static EstadosocionegocioFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new EstadosocionegocioFrm();
                }
        ...
        private void EstadosocionegocioFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllEstadosocionegocio("nombreestadosocionegocio");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new EstadosocionegocioMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void EstadosocionegocioFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
