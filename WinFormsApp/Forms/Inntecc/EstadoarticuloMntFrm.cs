...
{
    public partial class EstadoarticuloMntFrm : XtraForm
    {
        ...
        public EstadoarticuloFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Estadoarticulo EstadoarticuloMnt { get; set; }

        public EstadoarticuloMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, EstadoarticuloFrm formParent) 
        {
        ...
        private void EstadoarticuloMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    EstadoarticuloMnt = new Estadoarticulo();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                EstadoarticuloMnt = Service.GetEstadoarticulo(IdEntidadMnt);

                iNombreestadoarticulo.EditValue = EstadoarticuloMnt.Nombreestadoarticulo;
                iPermitecomprar.EditValue = EstadoarticuloMnt.Permitecomprar;
                iPermitevender.EditValue = EstadoarticuloMnt.Permitevender;
                iPermiteconsumointerno.EditValue = EstadoarticuloMnt.Permiteconsumointerno;
        ...
        private bool Guardar()
        {
            ...
            EstadoarticuloMnt.Nombreestadoarticulo = iNombreestadoarticulo.Text.Trim();
            EstadoarticuloMnt.Permitecomprar = (bool)iPermitecomprar.EditValue;
            EstadoarticuloMnt.Permitevender = (bool)iPermitevender.EditValue;
            EstadoarticuloMnt.Permiteconsumointerno = (bool)iPermiteconsumointerno.EditValue;
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveEstadoarticulo(EstadoarticuloMnt);
                    EstadoarticuloMnt.Idestadoarticulo = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateEstadoarticulo(EstadoarticuloMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteEstadoarticulo(IdEntidadMnt);
        ...
        private void EstadoarticuloMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void EstadoarticuloMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
