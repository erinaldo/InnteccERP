...
{
    public partial class TipoformatoFrm : XtraForm
    {        
        ...
        private static TipoformatoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipoformatoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idtipoformato";
        }

        public static TipoformatoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipoformatoFrm();
                }
        ...
        private void TipoformatoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTipoformato("nombretipoformato");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TipoformatoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void TipoformatoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
