...
{
    public partial class MarcaMntFrm : XtraForm
    {
        ...
        public MarcaFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Marca MarcaMnt { get; set; }

        public MarcaMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, MarcaFrm formParent) 
        {
        ...
        private void MarcaMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void TraerDatos()
        {
            try
            {
                MarcaMnt = Service.GetMarca(IdEntidadMnt);

                iNombremarca.EditValue = MarcaMnt.Nombremarca.Trim();
        ...
        private bool Guardar()
        {
            ...
            MarcaMnt.Nombremarca = iNombremarca.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveMarca(MarcaMnt);
                    MarcaMnt.Idmarca = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateMarca(MarcaMnt);
                    break;
                }
        ...
        private void MarcaMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void MarcaMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
