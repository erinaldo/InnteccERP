...
{
    public partial class ModeloautorizacionFrm : XtraForm
    {        
        ...
        private static ModeloautorizacionFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private ModeloautorizacionFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idmodeloautorizacion";            
        }

        public static ModeloautorizacionFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ModeloautorizacionFrm();
                }
        ...
        private void ModeloautorizacionFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwModeloautorizacion(whereEtapa,"nombremodelo");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new ModeloautorizacionMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void ModeloautorizacionFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
