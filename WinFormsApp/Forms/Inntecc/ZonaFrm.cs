...
{
    public partial class ZonaFrm : XtraForm
    {        
        ...
        private static ZonaFrm _uniqueInstance;
        ...
        private ZonaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idzona";
        }

        public static ZonaFrm GetInstance()
        {
        ...
        private void ZonaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllZona("nombrezona"); ;
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new ZonaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void ZonaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
