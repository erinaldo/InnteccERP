...
{
    public partial class ArticuloclasificacionFrm : XtraForm
    {        
        ...
        private static ArticuloclasificacionFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private ArticuloclasificacionFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idarticuloclasificacion";
        }

        public static ArticuloclasificacionFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ArticuloclasificacionFrm();
                }
        ...
        private void ArticuloclasificacionFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwArticuloclasificacion("codigoclasificacion");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new ArticuloclasificacionMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteArticuloclasificacion(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void ArticuloclasificacionFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
