...
{
    public partial class EmpleadoFrm : XtraForm
    {        
        ...
        private static EmpleadoFrm _uniqueInstance;
        ...
        private EmpleadoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idempleado";
        }

        public static EmpleadoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new EmpleadoFrm();
                }
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwEmpleado(condicionEmpresa, "Codigo"); ;
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new EmpleadoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void EmpleadoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
