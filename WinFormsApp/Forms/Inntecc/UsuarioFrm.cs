...
{
    public partial class UsuarioFrm : XtraForm
    {        
        ...
        private static UsuarioFrm _uniqueInstance;
        ...
        private UsuarioFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idusuario";
        }

        public static UsuarioFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new UsuarioFrm();
                }
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwUsuario(condicionEmpresa, "nombreusuario");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new UsuarioMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void UsuarioFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
