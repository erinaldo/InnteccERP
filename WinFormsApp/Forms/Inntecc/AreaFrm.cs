...
{
    public partial class AreaFrm : XtraForm
    {        
        ...
        private static AreaFrm _uniqueInstance;
        ...
        private AreaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idarea";
        }

        public static AreaFrm GetInstance()
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwArea(condicion, "codigoarea");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new AreaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void AreaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
