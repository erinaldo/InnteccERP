...
{
    public partial class EntidadfinancieraFrm : XtraForm
    {        
        ...
        private static EntidadfinancieraFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private EntidadfinancieraFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Identfinaciera";            
        }

        public static EntidadfinancieraFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new EntidadfinancieraFrm();
                }
        ...
        private void EntidadfinancieraFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllEntidadfinanciera("codentidadfinaciera");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new EntidadfinancieraMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void EntidadfinancieraFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
