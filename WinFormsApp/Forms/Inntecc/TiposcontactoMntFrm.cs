...
{
    public partial class TiposcontactoMntFrm : XtraForm
    {
        ...
        public TiposcontactoFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Tiposcontacto TiposcontactoMnt { get; set; }

        public TiposcontactoMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, TiposcontactoFrm formParent) 
        {
        ...
        private void TiposcontactoMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    TiposcontactoMnt = new Tiposcontacto();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                TiposcontactoMnt = Service.GetTiposcontacto(IdEntidadMnt);

                iNombretipocontacto.EditValue = TiposcontactoMnt.Nombretipocontacto;
        ...
        private bool Guardar()
        {
            ...
            TiposcontactoMnt.Nombretipocontacto = iNombretipocontacto.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveTiposcontacto(TiposcontactoMnt);
                    TiposcontactoMnt.Idtipocontacto = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateTiposcontacto(TiposcontactoMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteTiposcontacto(IdEntidadMnt);
        ...
        private void TiposcontactoMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void TiposcontactoMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
