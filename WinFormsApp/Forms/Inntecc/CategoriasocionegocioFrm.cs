...
{
    public partial class CategoriasocionegocioFrm : XtraForm
    {        
        ...
        private static CategoriasocionegocioFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private CategoriasocionegocioFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idcategoriasocionegocio";
        }

        public static CategoriasocionegocioFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new CategoriasocionegocioFrm();
                }
        ...
        private void CategoriasocionegocioFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllCategoriasocionegocio("Nombrecategoriasocionegoio");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new CategoriasocionegocioMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteCategoriasocionegocio(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void CategoriasocionegocioFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
