...
{
    public partial class ZonaMntFrm : XtraForm
    {
        ...
        public ZonaFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Zona ZonaMnt { get; set; }

        public ZonaMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, ZonaFrm formParent) 
        {
        ...
        private void ZonaMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void TraerDatos()
        {
            try
            {
                ZonaMnt = Service.GetZona(IdEntidadMnt);

                iNombrezona.EditValue = ZonaMnt.Nombrezona.Trim();
        ...
        private bool Guardar()
        {
            ...
            ZonaMnt.Nombrezona = iNombrezona.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveZona(ZonaMnt);
                    ZonaMnt.Idzona = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateZona(ZonaMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteZona(IdEntidadMnt);
        ...
        private void ZonaMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void ZonaMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
