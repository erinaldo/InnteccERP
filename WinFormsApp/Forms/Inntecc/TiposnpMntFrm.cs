...
{
    public partial class TiposnpMntFrm : XtraForm
    {
        ...
        public TiposnpFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Tiposnp TiposnpMnt { get; set; }

        public TiposnpMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, TiposnpFrm formParent) 
        {
        ...
        private void TiposnpMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void TraerDatos()
        {
            try
            {
                TiposnpMnt = Service.GetTiposnp(IdEntidadMnt);

                iNombretiposnp.EditValue = TiposnpMnt.Nombretiposnp;
        ...
        private bool Guardar()
        {
            ...
            TiposnpMnt.Nombretiposnp = iNombretiposnp.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveTiposnp(TiposnpMnt);
                    TiposnpMnt.Idtiposnp = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateTiposnp(TiposnpMnt);
                    break;
                }
        ...
        private void TiposnpMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void TiposnpMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
