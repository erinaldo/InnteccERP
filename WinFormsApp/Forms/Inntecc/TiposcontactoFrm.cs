...
{
    public partial class TiposcontactoFrm : XtraForm
    {        
        ...
        private static TiposcontactoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TiposcontactoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "idTipocontacto";
        }
        public static TiposcontactoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TiposcontactoFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void TiposcontactoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTiposcontacto("nombretipocontacto");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TiposcontactoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void TiposcontactoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
