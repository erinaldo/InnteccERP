...
{
    public partial class TipocontratoempleadoFrm : XtraForm
    {        
        ...
        private static TipocontratoempleadoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipocontratoempleadoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idtipocontratoempleado";
        }

        public static TipocontratoempleadoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipocontratoempleadoFrm();
                }
        ...
        private void TipocontratoempleadoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllTipocontratoempleado("nombretipocontratoempleado");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TipocontratoempleadoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void TipocontratoempleadoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
