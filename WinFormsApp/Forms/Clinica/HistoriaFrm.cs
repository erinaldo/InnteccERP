...
{
    public partial class HistoriaFrm : XtraForm
    {        
        ...
        private static HistoriaFrm _uniqueInstance;
        ...
        private HistoriaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idhistoria";
        }

        public static HistoriaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new HistoriaFrm();
                }
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwHistoria("Razonsocialclientetitular");
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteHistoria(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void HistoriaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
