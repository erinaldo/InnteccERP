...
{
    public partial class TipoarchivoMntFrm : XtraForm
    {
        ...
        public TipoarchivoFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Tipoarchivo TipoarchivoMnt { get; set; }

        public TipoarchivoMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, TipoarchivoFrm formParent) 
        {
        ...
        private void TipoarchivoMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    TipoarchivoMnt = new Tipoarchivo();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                TipoarchivoMnt = Service.GetTipoarchivo(IdEntidadMnt);

                iNombretipoarchivo.EditValue = TipoarchivoMnt.Nombretipoarchivo;
        ...
        private bool Guardar()
        {
            ...
            TipoarchivoMnt.Nombretipoarchivo = iNombretipoarchivo.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveTipoarchivo(TipoarchivoMnt);
                    TipoarchivoMnt.Idtipoarchivo = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateTipoarchivo(TipoarchivoMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteTipoarchivo(IdEntidadMnt);
        ...
        private void TipoarchivoMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void TipoarchivoMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
