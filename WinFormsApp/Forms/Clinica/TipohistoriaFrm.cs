...
{
    public partial class TipohistoriaFrm : XtraForm
    {        
        ...
        private static TipohistoriaFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipohistoriaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idtipohistoria";
        }

        public static TipohistoriaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipohistoriaFrm();
                }
        ...
        private void TipohistoriaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllTipohistoria("Nombretipohistoria");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TipohistoriaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void TipohistoriaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
