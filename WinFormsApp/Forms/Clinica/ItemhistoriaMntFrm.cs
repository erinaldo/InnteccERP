...
{
    public partial class ItemhistoriaMntFrm : XtraForm
    {
        ...
        public ItemhistoriaFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Itemhistoria ItemhistoriaMnt { get; set; }

        public ItemhistoriaMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, ItemhistoriaFrm formParent) 
        {
        ...
        private void ItemhistoriaMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    ItemhistoriaMnt = new Itemhistoria();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                ItemhistoriaMnt = Service.GetItemhistoria(IdEntidadMnt);

                iIdcategoriaitem.EditValue = ItemhistoriaMnt.Idcategoriaitem;
                iOrdenitemhistoria.EditValue = ItemhistoriaMnt.Ordenitemhistoria;
                iNombreitemhistoria.EditValue = ItemhistoriaMnt.Nombreitemhistoria;
                iTipodatoitemhistoria.EditValue = ItemhistoriaMnt.Tipodatoitemhistoria;
                iRequierearchivo.EditValue = ItemhistoriaMnt.Requierearchivo;
                iRequiereplanembarazoparto.EditValue = ItemhistoriaMnt.Requiereplanembarazoparto;
        ...
        private bool Guardar()
        {
            ...
            ItemhistoriaMnt.Idcategoriaitem = (int)iIdcategoriaitem.EditValue;
            ItemhistoriaMnt.Ordenitemhistoria = (int)iOrdenitemhistoria.EditValue;
            ItemhistoriaMnt.Nombreitemhistoria = iNombreitemhistoria.Text.Trim();
            ItemhistoriaMnt.Tipodatoitemhistoria = iTipodatoitemhistoria.Text.Trim();
            ItemhistoriaMnt.Requierearchivo = (bool)iRequierearchivo.EditValue;
            ItemhistoriaMnt.Requiereplanembarazoparto = (bool)iRequiereplanembarazoparto.EditValue;
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveItemhistoria(ItemhistoriaMnt);
                    ItemhistoriaMnt.Iditemhistoria = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateItemhistoria(ItemhistoriaMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteItemhistoria(IdEntidadMnt);
        ...
        private void ItemhistoriaMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void ItemhistoriaMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
