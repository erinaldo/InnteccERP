...
{
    public partial class TipohistoriaMntFrm : XtraForm
    {
        ...
        public TipohistoriaFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Tipohistoria TipohistoriaMnt { get; set; }

        public TipohistoriaMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, TipohistoriaFrm formParent) 
        {
        ...
        private void TipohistoriaMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    TipohistoriaMnt = new Tipohistoria();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                TipohistoriaMnt = Service.GetTipohistoria(IdEntidadMnt);

                iCodigotipohistoria.EditValue = TipohistoriaMnt.Codigotipohistoria;
                iNombretipohistoria.EditValue = TipohistoriaMnt.Nombretipohistoria;
                iOrdentipohistoria.EditValue = TipohistoriaMnt.Ordentipohistoria;
            }
            catch
            {
                DeshabilitarBtnMnt();
        ...
        private bool Guardar()
        {
            ...
            TipohistoriaMnt.Codigotipohistoria = iCodigotipohistoria.Text.Trim();
            TipohistoriaMnt.Nombretipohistoria = iNombretipohistoria.Text.Trim();
            TipohistoriaMnt.Ordentipohistoria = (int)iOrdentipohistoria.EditValue;
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveTipohistoria(TipohistoriaMnt);
                    TipohistoriaMnt.Idtipohistoria = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateTipohistoria(TipohistoriaMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteTipohistoria(IdEntidadMnt);
        ...
        private void TipohistoriaMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void TipohistoriaMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
