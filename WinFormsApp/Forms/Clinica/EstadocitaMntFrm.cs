...
{
    public partial class EstadocitaMntFrm : XtraForm
    {
        ...
        public EstadocitaFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Estadocita EstadocitaMnt { get; set; }

        public EstadocitaMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, EstadocitaFrm formParent) 
        {
        ...
        private void EstadocitaMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private bool Guardar()
        {
            ...
            EstadocitaMnt.Nombreestadocita = iNombremarca.Text.Trim();
            EstadocitaMnt.Colorestadocita = iColorestado.Color.ToArgb();
            EstadocitaMnt.Estadopordefectoprogramacion = (bool)iEstadopordefectoprogramacion.EditValue;
            EstadocitaMnt.Imagenestado = (byte[])iImagenestado.EditValue;
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveEstadocita(EstadocitaMnt);
                    EstadocitaMnt.Idestadocita = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateEstadocita(EstadocitaMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteEstadocita(IdEntidadMnt);
        ...
        private void EstadocitaMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void EstadocitaMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
