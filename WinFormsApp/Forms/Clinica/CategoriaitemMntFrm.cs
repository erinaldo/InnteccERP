...
{
    public partial class CategoriaitemMntFrm : XtraForm
    {
        ...
        public CategoriaitemFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Categoriaitem CategoriaitemMnt { get; set; }

        public CategoriaitemMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, CategoriaitemFrm formParent) 
        {
        ...
        private void CategoriaitemMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    CategoriaitemMnt = new Categoriaitem();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                CategoriaitemMnt = Service.GetCategoriaitem(IdEntidadMnt);

                iCodigocategoriaitem.EditValue = CategoriaitemMnt.Codigocategoriaitem;
                iNombrecategoriaitem.EditValue = CategoriaitemMnt.Nombrecategoriaitem;
                iOrdencategoriaitem.EditValue = CategoriaitemMnt.Ordencategoriaitem;
        ...
        private bool Guardar()
        {
            ...
            CategoriaitemMnt.Codigocategoriaitem = iCodigocategoriaitem.Text.Trim();
            CategoriaitemMnt.Nombrecategoriaitem = iNombrecategoriaitem.Text.Trim();
            CategoriaitemMnt.Ordencategoriaitem = (int)iOrdencategoriaitem.EditValue;
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveCategoriaitem(CategoriaitemMnt);
                    CategoriaitemMnt.Idcategoriaitem = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateCategoriaitem(CategoriaitemMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteCategoriaitem(IdEntidadMnt);
        ...
        private void CategoriaitemMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void CategoriaitemMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
