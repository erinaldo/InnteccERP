...
{
    public partial class MotivocitaMntFrm : XtraForm
    {
        ...
        public MotivocitaFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Motivocita MotivocitaMnt { get; set; }

        public MotivocitaMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, MotivocitaFrm formParent) 
        {
        ...
        private void MotivocitaMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void TraerDatos()
        {
            try
            {
                MotivocitaMnt = Service.GetMotivocita(IdEntidadMnt);

                iNombremotivocita.EditValue = MotivocitaMnt.Nombremotivocita.Trim();
                iMotivopordefectoprogramacion.EditValue = MotivocitaMnt.Motivopordefectoprogramacion;
                iTiempoduracion.EditValue = MotivocitaMnt.Tiempoduracion;
            }
            catch
            {
                DeshabilitarBtnMnt();
        ...
        private bool Guardar()
        {
            ...
            MotivocitaMnt.Nombremotivocita = iNombremotivocita.Text.Trim();
            MotivocitaMnt.Motivopordefectoprogramacion = (bool)iMotivopordefectoprogramacion.EditValue;
            MotivocitaMnt.Tiempoduracion = iTiempoduracion.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveMotivocita(MotivocitaMnt);
                    MotivocitaMnt.Idmotivocita = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateMotivocita(MotivocitaMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteMotivocita(IdEntidadMnt);
        ...
        private void MotivocitaMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void MotivocitaMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
