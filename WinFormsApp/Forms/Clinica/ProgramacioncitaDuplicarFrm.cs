...
{
    public partial class ProgramacioncitaDuplicarFrm : XtraForm
    {        
        ...
        private static ProgramacioncitaDuplicarFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private ProgramacioncitaDuplicarFrm()
        {
        ...
        public static ProgramacioncitaDuplicarFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ProgramacioncitaDuplicarFrm();
                }
        ...
        private void ProgramacioncitaDuplicarFrm_Load(object sender, EventArgs e)
        {
        ...
        private void ProgramacioncitaDuplicarFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
