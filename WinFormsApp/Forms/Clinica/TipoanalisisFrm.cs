...
{
    public partial class TipoanalisisFrm : XtraForm
    {        
        ...
        private static TipoanalisisFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipoanalisisFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idestadocita";
        }

        public static TipoanalisisFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipoanalisisFrm();
                }
        ...
        private void TipoanalisisFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllEstadocita("nombreestadocita");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TipoanalisisMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void TipoanalisisFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
