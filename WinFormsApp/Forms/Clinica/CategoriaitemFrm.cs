...
{
    public partial class CategoriaitemFrm : XtraForm
    {        
        ...
        private static CategoriaitemFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private CategoriaitemFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idcategoriaitem";
        }

        public static CategoriaitemFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new CategoriaitemFrm();
                }
        ...
        private void CategoriaitemFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllCategoriaitem("Nombrecategoriaitem");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new CategoriaitemMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void CategoriaitemFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
