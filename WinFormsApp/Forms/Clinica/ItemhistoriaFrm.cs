...
{
    public partial class ItemhistoriaFrm : XtraForm
    {        
        ...
        private static ItemhistoriaFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private ItemhistoriaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Iditemhistoria";
        }

        public static ItemhistoriaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ItemhistoriaFrm();
                }
        ...
        private void ItemhistoriaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwItemhistoria("Nombreitemhistoria");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new ItemhistoriaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void ItemhistoriaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
