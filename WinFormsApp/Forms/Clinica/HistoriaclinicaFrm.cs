...
{
    public partial class HistoriaclinicaFrm : XtraForm
    {        
        ...
        private static HistoriaclinicaFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private HistoriaclinicaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idhistoriaclinica";
        }
        ...
        private void HistoriaclinicaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwHistoriaclinica("numerohistoria");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new HistoriaclinicaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteHistoriaclinica(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void HistoriaclinicaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
