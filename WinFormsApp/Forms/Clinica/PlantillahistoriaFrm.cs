...
{
    public partial class PlantillahistoriaFrm : XtraForm
    {        
        ...
        private static PlantillahistoriaFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private PlantillahistoriaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idplantillahistoria";
        }

        public static PlantillahistoriaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new PlantillahistoriaFrm();
                }
        ...
        private void PlantillahistoriaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwPlantillahistoria("Nombretipohistoria");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new PlantillahistoriaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void PlantillahistoriaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
