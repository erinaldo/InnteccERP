...
{
    public partial class TipoarchivoFrm : XtraForm
    {        
        ...
        private static TipoarchivoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private TipoarchivoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idtipoarchivo";
        }

        public static TipoarchivoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new TipoarchivoFrm();
                }
        ...
        private void TipoarchivoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllTipoarchivo("Nombretipoarchivo");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new TipoarchivoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void TipoarchivoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
