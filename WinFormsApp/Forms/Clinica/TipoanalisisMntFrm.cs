...
{
    public partial class TipoanalisisMntFrm : XtraForm
    {
        ...
        public TipoanalisisFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Tipoanalisis TipoanalisisMnt { get; set; }

        public TipoanalisisMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, TipoanalisisFrm formParent) 
        {
        ...
        private void TipoanalisisMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    TipoanalisisMnt = new Tipoanalisis();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                TipoanalisisMnt = Service.GetTipoanalisis(IdEntidadMnt);

                iNombremarca.EditValue = TipoanalisisMnt.Nombretipoanalisis.Trim();
        ...
        private bool Guardar()
        {
            ...
            TipoanalisisMnt.Nombretipoanalisis = iNombremarca.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveTipoanalisis(TipoanalisisMnt);
                    TipoanalisisMnt.Idtipoanalisis = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateTipoanalisis(TipoanalisisMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteTipoanalisis(IdEntidadMnt);
        ...
        private void TipoanalisisMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void TipoanalisisMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
