...
{
    public partial class MotivocitaFrm : XtraForm
    {        
        ...
        private static MotivocitaFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private MotivocitaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idmotivocita";
        }

        public static MotivocitaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new MotivocitaFrm();
                }
        ...
        private void MotivocitaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllMotivocita("nombremotivocita");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new MotivocitaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void MotivocitaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
