...
{
    public partial class ProgramacioncitaFrm : XtraForm
    {        
        ...
        private static ProgramacioncitaFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private ProgramacioncitaFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idprogramacioncita";
        }

        public static ProgramacioncitaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new ProgramacioncitaFrm();
                }
        ...
        private void ProgramacioncitaFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwProgramacioncita("Fechaprogramacion");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            ProgramacioncitaMntFrm formMnt = new ProgramacioncitaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void ProgramacioncitaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
