...
{
    public partial class EstadocitaFrm : XtraForm
    {        
        ...
        private static EstadocitaFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private EstadocitaFrm()
        {
        ...
        public static EstadocitaFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new EstadocitaFrm();
                }
        ...
        private void EstadocitaFrm_Load(object sender, EventArgs e)
        {
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new EstadocitaMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void EstadocitaFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
