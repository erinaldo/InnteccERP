...
{
    public partial class UbicacionFrm : XtraForm
    {        
        ...
        private static UbicacionFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private UbicacionFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idubicacion";
        }
        public static UbicacionFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new UbicacionFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void UbicacionFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwUbicacion(whereSucursal,"nombreubicacion");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new UbicacionMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteUbicacion(IdEntidadMnt);
                    CargarDatosConsulta();
                }
                catch
                {
        ...
        private void UbicacionFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
