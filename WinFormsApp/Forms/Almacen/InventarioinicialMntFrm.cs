...
{
    public partial class InventarioinicialMntFrm : XtraForm
    {
        ...
        public InventarioinicialFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Inventarioinicial InventarioinicialMnt { get; set; }

        public InventarioinicialMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, InventarioinicialFrm formParent) 
        {
        ...
        private void InventarioinicialMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    InventarioinicialMnt = new Inventarioinicial();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                InventarioinicialMnt = Service.GetInventarioinicial(IdEntidadMnt);

                rIdempresa.EditValue = InventarioinicialMnt.Idempresa;
                iFechainventarioinicial.EditValue = InventarioinicialMnt.Fechainventarioinicial;
        ...
        private bool Guardar()
        {
            ...
            InventarioinicialMnt.Idempresa = (int)rIdempresa.EditValue;
            InventarioinicialMnt.Fechainventarioinicial = (DateTime)iFechainventarioinicial.EditValue;
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveInventarioinicial(InventarioinicialMnt);
                    InventarioinicialMnt.Idinventarioinicial = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateInventarioinicial(InventarioinicialMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteInventarioinicial(IdEntidadMnt);
        ...
        private void InventarioinicialMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void InventarioinicialMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
