...
{
    public partial class EstadoreclamoFrm : XtraForm
    {        
        ...
        private static EstadoreclamoFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private EstadoreclamoFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idestadoreclamo";
        }

        public static EstadoreclamoFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new EstadoreclamoFrm();
                }
        ...
        private void EstadoreclamoFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllEstadoreclamo("nombreestadoreclamo");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new EstadoreclamoMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void EstadoreclamoFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
