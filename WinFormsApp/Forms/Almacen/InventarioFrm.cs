...
{
    public partial class InventarioFrm : XtraForm
    {        
        ...
        private static InventarioFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private InventarioFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Idinventario";            
        }
        ...
        public static InventarioFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new InventarioFrm();
                }
        ...
        public void CargarDatosConsulta()
        {
            ...
            var resul = Service.GetAllVwInventario(where, "nombretipoformato,serieinventario,numeroinventario");
        ...
        private void ShowFormMnt()
        {
            ...
            //Cursor = Cursors.WaitCursor;
            AsignarIdEntidadMnt();
            var formMnt = new InventarioMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        ...
        private void InventarioFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
