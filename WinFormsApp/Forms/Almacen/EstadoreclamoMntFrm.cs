...
{
    public partial class EstadoreclamoMntFrm : XtraForm
    {
        ...
        public EstadoreclamoFrm FormParent { get; set; }

        private readonly DXErrorProvider _errorProvider;
        public Accesoform Permisos { get; set; }

        static readonly IService Service = new Service();
        public Estadoreclamo EstadoreclamoMnt { get; set; }

        public EstadoreclamoMntFrm(int idEntidadMnt, TipoMantenimiento tipoMnt, GridControl gridParent, EstadoreclamoFrm formParent) 
        {
        ...
        private void EstadoreclamoMntFrm_Load(object sender, EventArgs e)
        {
            EstablecerPermisos();
        ...
        private void InicioTipoMantenimiento()
        {
            switch (TipoMnt)
            {
                case TipoMantenimiento.Nuevo:
                    ...
                    EstadoreclamoMnt = new Estadoreclamo();
                    break;
        ...
        private void TraerDatos()
        {
            try
            {
                EstadoreclamoMnt = Service.GetEstadoreclamo(IdEntidadMnt);

                iNombreestadoreclamo.EditValue = EstadoreclamoMnt.Nombreestadoreclamo;
        ...
        private bool Guardar()
        {
            ...
            EstadoreclamoMnt.Nombreestadoreclamo = iNombreestadoreclamo.Text.Trim();
            ...
            try
            {
                ...
                {
                case TipoMantenimiento.Nuevo:
                    IdEntidadMnt = Service.SaveEstadoreclamo(EstadoreclamoMnt);
                    EstadoreclamoMnt.Idestadoreclamo = IdEntidadMnt;
                    pkIdEntidad.EditValue = IdEntidadMnt;
                    break;
                case TipoMantenimiento.Modificar:
                    Service.UpdateEstadoreclamo(EstadoreclamoMnt);
                    break;
                }
        ...
        private void EliminaRegistro()
        {
            if (Convert.ToInt32(pkIdEntidad.EditValue) > 0)
            {
                                                        ...
                                                        MessageBoxIcon.Question, MessageBoxDefaultButton.Button1))
                {
                    ...
                    {
                        Cursor = Cursors.WaitCursor;
                        Service.DeleteEstadoreclamo(IdEntidadMnt);
        ...
        private void EstadoreclamoMntFrm_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void EstadoreclamoMntFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormParent != null)
            {                
                if (SeEliminoObjeto)
