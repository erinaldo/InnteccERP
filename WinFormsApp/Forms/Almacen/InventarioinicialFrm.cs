...
{
    public partial class InventarioinicialFrm : XtraForm
    {        
        ...
        private static InventarioinicialFrm _uniqueInstance;
        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();

        private InventarioinicialFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreColumnaPk = "Idinventarioinicial";
        }

        public static InventarioinicialFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new InventarioinicialFrm();
                }
        ...
        private void InventarioinicialFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta()
        {
            ...
            gcConsulta.DataSource = Service.GetAllVwInventarioinicial(condicionEmpresa, "nombreempresa");
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new InventarioinicialMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void InventarioinicialFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
