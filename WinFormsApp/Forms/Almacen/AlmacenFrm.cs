...
{
    public partial class AlmacenFrm : XtraForm
    {
        private static AlmacenFrm _uniqueInstance;
        ...
        public static AlmacenFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new AlmacenFrm();
                }
        ...
        public void CargarDatosConsulta()
        {
            ...
            var condicion = string.Format("idsucursal = {0}", SessionApp.SucursalSel.Idsucursal);
            gcConsulta.DataSource = Service.GetAllVwAlmacen(condicion, "codigoalmacen");

            gvConsulta.BestFitColumns();
            gcConsulta.EndUpdate();

            var rowCount = gvConsulta.RowCount;
        ...
        private void ShowFormMnt()
        {
            ...
            AsignarIdEntidadMnt();
            var formMnt = new AlmacenMntFrm(IdEntidadMnt, TipoMnt, gcConsulta, this);
            formMnt.ShowDialog();
        }
        ...
        private void EliminaRegistro()
        {
            if (DialogResult.Yes == XtraMessageBox.Show(
                Resources.msgEliminarRegistro,
                Resources.titPregunta,
        ...
        private void AlmacenFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void AsignarIdEntidadMnt()
        {
            switch (TipoMnt)
            {
                ...
                case TipoMantenimiento.Eliminar:
                    IdEntidadMnt =
                        Convert.ToInt32(gvConsulta.GetRowCellValue(gvConsulta.FocusedRowHandle, NombreColumnaPk));
                    break;
