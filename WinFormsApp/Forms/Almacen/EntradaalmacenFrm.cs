...
{
    public partial class EntradaalmacenFrm : XtraForm
    {
        ...
        private static EntradaalmacenFrm _uniqueInstance;

        private static readonly object SyncLock = new Object();

        static readonly IService Service = new Service();
        private EntradaalmacenFrm()
        {
            ...
            IdEntidadMnt = 0;
            NombreIdEntidadMnt = "Identradaalmacen";            
        }
        public static EntradaalmacenFrm GetInstance()
        {
            ...
            lock (SyncLock)
            {
                ...
                {
                    _uniqueInstance = new EntradaalmacenFrm();
                }
                _uniqueInstance.BringToFront();
                return _uniqueInstance;
            }
        }
        private void EntradaalmacenFrm_Load(object sender, EventArgs e)
        {
        ...
        public void CargarDatosConsulta(string descripcionFiltroFecha, string fechaInicialConsulta, string fechaFinalConsulta)
        {
            ...
            string filtro = string.Format("idsucursal = {0} and fechaentrada between '{1}' and '{2}'", SessionApp.SucursalSel.Idsucursal, fechaInicialConsulta, fechaFinalConsulta);            
            VwEntradaalmacenList = Service.GetAllVwEntradaalmacen(filtro,"nombretipoformato,serieentradaalmacen,numeroentradaalmacen");
            gcConsulta.DataSource = VwEntradaalmacenList;
        ...
        private void EliminaRegistro()
        {
                                                    ...
                                                    MessageBoxDefaultButton.Button1))
            {
                ...
                try
                {
                    Cursor = Cursors.WaitCursor;
                    AsignarIdEntidadMnt();
                    Service.DeleteEntradaalmacen(IdEntidadMnt);
                    CargarDatosConsulta(DescripcionFiltroFecha, FechaInicialConsulta, FechaFinalConsulta);
                }
                catch
                {
        ...
        private void EntradaalmacenFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
